...
func (opts *HelloWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *HelloWorkflowOptions {
...
func (a *exampleActivities) Hello(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.HelloResponse, err error) {
...
func (a *exampleActivities) Goodbye(ctx context.Context, input *v13.SignalRequest) (err error) {
