...
var file_example_searchattributes_v1_searchattributes_proto_goTypes = []interface{}{
...
func file_example_searchattributes_v1_searchattributes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_example_searchattributes_v1_searchattributes_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchAttributesInput); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
