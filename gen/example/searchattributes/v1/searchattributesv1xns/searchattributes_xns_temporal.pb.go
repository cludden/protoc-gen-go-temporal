...
func (opts *SearchAttributesWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SearchAttributesWorkflowOptions {
...
func (a *exampleActivities) SearchAttributes(ctx context.Context, input *v13.WorkflowRequest) (err error) {
