	...
	commands := []*v2.Command{
		{
			...
			Flags: []v2.Flag{
				...
				&v2.TimestampFlag{
					...
					Usage:    "set the value of the operation's \"CustomDatetimeField\" parameter",
					Category: "INPUT",
