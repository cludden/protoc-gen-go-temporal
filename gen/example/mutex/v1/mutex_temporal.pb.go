...
func (i *MutexWorkflowInput) ContinueAsNew(ctx workflow.Context, nextInput ...*MutexInput) error {
	next := i.Req
...
// WithTypedSearchAttributes sets the TypedSearchAttributes value
func (o *MutexChildOptions) WithTypedSearchAttributes(tsa temporal.SearchAttributes) *MutexChildOptions {
	o.typedSearchAttributes = &tsa
	return o
}
...
// ContinueAsNew returns an appropriately configured ContinueAsNewError
func (i *SampleWorkflowWithMutexWorkflowInput) ContinueAsNew(ctx workflow.Context, nextInput ...*SampleWorkflowWithMutexInput) error {
	next := i.Req
	if len(nextInput) > 0 && nextInput[0] != nil {
		next = nextInput[0]
	}
...
// WithTypedSearchAttributes sets the TypedSearchAttributes value
func (o *SampleWorkflowWithMutexChildOptions) WithTypedSearchAttributes(tsa temporal.SearchAttributes) *SampleWorkflowWithMutexChildOptions {
	o.typedSearchAttributes = &tsa
	return o
}
