	...
	commands := []*v2.Command{
		{
			...
			Flags: []v2.Flag{
				...
				&v2.DurationFlag{
					Name:     "timeout",
					Usage:    "set the value of the operation's \"Timeout\" parameter",
					Category: "INPUT",
				},
			},
...
func UnmarshalCliFlagsToAcquireLockInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*AcquireLockInput, error) {
	...
	if cmd.IsSet("workflow-id") {
		hasValues = true
		value := cmd.String(opts.FlagName("workflow-id"))
		result.WorkflowId = value
	}
	if cmd.IsSet("timeout") {
		hasValues = true
		value := durationpb.New(cmd.Duration(opts.FlagName("timeout")))
...
func UnmarshalCliFlagsToLockAcquiredInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*LockAcquiredInput, error) {
	...
	if cmd.IsSet("lease-id") {
		hasValues = true
		value := cmd.String(opts.FlagName("lease-id"))
...
func UnmarshalCliFlagsToMutexInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*MutexInput, error) {
	...
	if cmd.IsSet("resource-id") {
		hasValues = true
		value := cmd.String(opts.FlagName("resource-id"))
