...
func (opts *MutexWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *MutexWorkflowOptions {
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *SampleWorkflowWithMutexWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SampleWorkflowWithMutexWorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
func (a *exampleActivities) Mutex(ctx context.Context, input *v13.WorkflowRequest) (err error) {
...
func (a *exampleActivities) MutexWithAcquireLock(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// unmarshal workflow request
	var req v1.MutexInput
	if err := input.Request.UnmarshalTo(&req); err != nil {
		return exampleOptions.convertError(temporal.NewNonRetryableApplicationError(
...
func (a *exampleActivities) SampleWorkflowWithMutex(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// unmarshal workflow request
...
func (a *exampleActivities) AcquireLock(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *exampleActivities) LockAcquired(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *exampleActivities) ReleaseLock(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
