...
type XnsWorkflows interface {
	// example.xns.v1.Xns.ProvisionFoo initializes a new a(n) ProvisionFooWorkflow implementation
...
func newXnsCommands(options ...*XnsCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		// example.xns.v1.Xns.ProvisionFoo executes a(n) example.xns.v1.Xns.ProvisionFoo workflow,
		{
			Name:                   "provision-foo",
			Usage:                  "example.xns.v1.Xns.ProvisionFoo executes a(n) example.xns.v1.Xns.ProvisionFoo workflow",
			Category:               "WORKFLOWS",
...
func WithXnsSchemeTypes() scheme.Option {
	return func(s *scheme.Scheme) {
		...
		s.RegisterType(File_example_xns_v1_xns_proto.Messages().ByName("Foo"))
	}
}
