...
func (o *ProvisionFooOptions) WithEnableEagerStart(enable bool) *ProvisionFooOptions {
...
func (o *ProvisionFooOptions) WithPriority(priority temporal.Priority) *ProvisionFooOptions {
	o.priority = &priority
	return o
}
...
func (o *ProvisionFooOptions) WithPriorityKey(priorityKey int) *ProvisionFooOptions {
...
func (o *ProvisionFooOptions) WithFairnessKey(fairnessKey string) *ProvisionFooOptions {
...
func (o *ProvisionFooOptions) WithFairnessWeight(fairnessWeight float32) *ProvisionFooOptions {
...
func (o *ProvisionFooOptions) WithWorkflowIdConflictPolicy(policy enumsv1.WorkflowIdConflictPolicy) *ProvisionFooOptions {
...
func (i *ProvisionFooWorkflowInput) ContinueAsNew(ctx workflow.Context, input *ProvisionFooRequest, options ...workflow.ContinueAsNewErrorOptions) (*ProvisionFooResponse, error) {
	next := i.Req
	if input != nil {
		next = input
	}
	if len(options) > 0 {
		return nil, workflow.NewContinueAsNewErrorWithOptions(ctx, options[0], ProvisionFooWorkflowName, next)
	}
...
func (o *ProvisionFooChildOptions) WithDataConverter(dc converter.DataConverter) *ProvisionFooChildOptions {
	o.dc = dc
	return o
}
...
// WithPriority sets the Priority value
func (o *ProvisionFooChildOptions) WithPriority(priority temporal.Priority) *ProvisionFooChildOptions {
	o.priority = &priority
	return o
}

// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *ProvisionFooChildOptions) WithPriorityKey(priorityKey int) *ProvisionFooChildOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *ProvisionFooChildOptions) WithFairnessKey(fairnessKey string) *ProvisionFooChildOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *ProvisionFooChildOptions) WithFairnessWeight(fairnessWeight float32) *ProvisionFooChildOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
...
// WithTypedSearchAttributes sets the TypedSearchAttributes value
func (o *ProvisionFooChildOptions) WithTypedSearchAttributes(tsa temporal.SearchAttributes) *ProvisionFooChildOptions {
	o.typedSearchAttributes = &tsa
	return o
}
	...
	commands := []*v2.Command{
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				defer tc.Close()
				c := NewXnsClient(tc)
				req, err := UnmarshalCliFlagsToProvisionFooRequest(cmd, helpers.UnmarshalCliFlagsOptions{FromFile: "input-file"})
				if err != nil {
...
// WithPriority sets the Priority value
func (o *CreateFooOptions) WithPriority(priority temporal.Priority) *CreateFooOptions {
	o.priority = &priority
	return o
}

// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooOptions) WithPriorityKey(priorityKey int) *CreateFooOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooOptions) WithFairnessKey(fairnessKey string) *CreateFooOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooOptions) WithFairnessWeight(fairnessWeight float32) *CreateFooOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
...
// WithPriority sets the Priority value
func (o *CreateFooChildOptions) WithPriority(priority temporal.Priority) *CreateFooChildOptions {
	o.priority = &priority
	return o
}

// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooChildOptions) WithPriorityKey(priorityKey int) *CreateFooChildOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooChildOptions) WithFairnessKey(fairnessKey string) *CreateFooChildOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *CreateFooChildOptions) WithFairnessWeight(fairnessWeight float32) *CreateFooChildOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
...
// WithPriority sets the Priority value
func (o *NotifyActivityOptions) WithPriority(p temporal.Priority) *NotifyActivityOptions {
	o.priority = &p
	return o
}

// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *NotifyActivityOptions) WithPriorityKey(priorityKey int) *NotifyActivityOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *NotifyActivityOptions) WithFairnessKey(fairnessKey string) *NotifyActivityOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *NotifyActivityOptions) WithFairnessWeight(fairnessWeight float32) *NotifyActivityOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
