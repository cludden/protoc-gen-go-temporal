...
func (opts *ProvisionFooWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *ProvisionFooWorkflowOptions {
...
func (a *xnsActivities) ProvisionFoo(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.ProvisionFooResponse, err error) {
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *CreateFooWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *CreateFooWorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
func (a *exampleActivities) CreateFoo(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.CreateFooResponse, err error) {
	// unmarshal workflow request
...
func (a *exampleActivities) CreateFooWithSetFooProgress(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.CreateFooResponse, err error) {
	// unmarshal workflow request
	var req v1.CreateFooRequest
	if err := input.Request.UnmarshalTo(&req); err != nil {
		return nil, exampleOptions.convertError(temporal.NewNonRetryableApplicationError(
...
func (a *exampleActivities) GetFooProgress(ctx context.Context, input *v13.QueryRequest) (resp *v1.GetFooProgressResponse, err error) {
...
func (a *exampleActivities) SetFooProgress(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *exampleActivities) UpdateFooProgress(ctx context.Context, input *v13.UpdateRequest) (resp *v1.GetFooProgressResponse, err error) {
