...
func RegisterExampleActivities(r worker.ActivityRegistry, c v1.ExampleClient) {
	a := &exampleActivities{c}
	r.RegisterActivityWithOptions(a.CancelWorkflow, activity.RegisterOptions{Name: "example.v1.Example.CancelWorkflow"})
	r.RegisterActivityWithOptions(a.CreateFoo, activity.RegisterOptions{Name: v1.CreateFooWorkflowName})
	r.RegisterActivityWithOptions(a.CreateFooWithSetFooProgress, activity.RegisterOptions{Name: "example.v1.Example.CreateFooWithSetFooProgress"})
	r.RegisterActivityWithOptions(a.GetFooProgress, activity.RegisterOptions{Name: v1.GetFooProgressQueryName})
	r.RegisterActivityWithOptions(a.SetFooProgress, activity.RegisterOptions{Name: v1.SetFooProgressSignalName})
	r.RegisterActivityWithOptions(a.UpdateFooProgress, activity.RegisterOptions{Name: v1.UpdateFooProgressUpdateName})
}
...
func CreateFooAsync(ctx workflow.Context, req *v1.CreateFooInput, opts ...*CreateFooWorkflowOptions) (CreateFooRun, error) {
	...
	return &createFooRun{
		cancel: cancel,
		id:     wo.ID,
		future: workflow.ExecuteActivity(ctx, v1.CreateFooWorkflowName, &v11.WorkflowRequest{
...
func CreateFooWithSetFooProgressAsync(ctx workflow.Context, req *v1.CreateFooInput, signal *v1.SetFooProgressRequest, opts ...*CreateFooWorkflowOptions) (CreateFooRun, error) {
	...
	return &createFooRun{
		cancel: cancel,
		id:     wo.ID,
		future: workflow.ExecuteActivity(ctx, "example.v1.Example.CreateFooWithSetFooProgress", &v11.WorkflowRequest{
			Detached:             opt.Detached,
			HeartbeatInterval:    durationpb.New(opt.HeartbeatInterval),
			Request:              wreq,
			Signal:               wsignal,
...
func GetFooProgressAsync(ctx workflow.Context, workflowID string, runID string, opts ...*GetFooProgressQueryOptions) (GetFooProgressQueryHandle, error) {
	...
	return &getFooProgressQueryHandle{
		cancel: cancel,
		future: workflow.ExecuteActivity(ctx, v1.GetFooProgressQueryName, &v11.QueryRequest{
			HeartbeatInterval: durationpb.New(opt.HeartbeatInterval),
...
func SetFooProgressAsync(ctx workflow.Context, workflowID string, runID string, req *v1.SetFooProgressRequest, opts ...*SetFooProgressSignalOptions) (SetFooProgressSignalHandle, error) {
	...
	return &setFooProgressSignalHandle{
		cancel: cancel,
		future: workflow.ExecuteActivity(ctx, v1.SetFooProgressSignalName, &v11.SignalRequest{
			HeartbeatInterval: durationpb.New(opt.HeartbeatInterval),
			WorkflowId:        workflowID,
			RunId:             runID,
			Request:           wreq,
...
func UpdateFooProgressAsync(ctx workflow.Context, workflowID string, runID string, req *v1.SetFooProgressRequest, opts ...*UpdateFooProgressUpdateOptions) (UpdateFooProgressHandle, error) {
	...
	if uo.UpdateID == "" {
		...
		if err != nil {
			return nil, fmt.Errorf("error evaluating id expression for \"UpdateFooProgress\" update: %w", err)
		}
		uo.UpdateID = id
	}
	if uo.UpdateID == "" {
	...
	return &updateFooProgressHandle{
		cancel: cancel,
		id:     uo.UpdateID,
		future: workflow.ExecuteActivity(ctx, v1.UpdateFooProgressUpdateName, &v11.UpdateRequest{
			HeartbeatInterval:     durationpb.New(opt.HeartbeatInterval),
			Request:               wreq,
...
func CancelExampleWorkflowAsync(ctx workflow.Context, workflowID string, runID string) workflow.Future {
	...
	ctx = workflow.WithActivityOptions(ctx, ao)
	return workflow.ExecuteActivity(ctx, "example.v1.Example.CancelWorkflow", workflowID, runID)
}
...
func RegisterExternalActivities(r worker.ActivityRegistry, c v1.ExternalClient) {
	a := &externalActivities{c}
	r.RegisterActivityWithOptions(a.CancelWorkflow, activity.RegisterOptions{Name: "example.v1.External.CancelWorkflow"})
	r.RegisterActivityWithOptions(a.ProvisionFoo, activity.RegisterOptions{Name: v1.ProvisionFooWorkflowName})
}
...
func ProvisionFooAsync(ctx workflow.Context, req *v1.ProvisionFooInput, opts ...*ProvisionFooWorkflowOptions) (ProvisionFooRun, error) {
	...
	return &provisionFooRun{
		cancel: cancel,
		id:     wo.ID,
		future: workflow.ExecuteActivity(ctx, v1.ProvisionFooWorkflowName, &v11.WorkflowRequest{
			Detached:             opt.Detached,
			HeartbeatInterval:    durationpb.New(opt.HeartbeatInterval),
			Request:              wreq,
			StartWorkflowOptions: swo,
...
func CancelExternalWorkflowAsync(ctx workflow.Context, workflowID string, runID string) workflow.Future {
	...
	ctx = workflow.WithActivityOptions(ctx, ao)
	return workflow.ExecuteActivity(ctx, "example.v1.External.CancelWorkflow", workflowID, runID)
}
