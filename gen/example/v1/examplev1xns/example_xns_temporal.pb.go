...
import (
	...
	simplexns "github.com/cludden/protoc-gen-go-temporal/gen/simple/simplexns"
...
// ProvisionFooWorkflowOptions are used to configure a(n) example.v1.External.ProvisionFoo workflow execution
...
// ProvisionFooRun provides a handle to a example.v1.External.ProvisionFoo workflow execution
type ProvisionFooRun interface {
	...
	SomeSignal3(workflow.Context, *simple.SomeSignal3Request, ...*simplexns.SomeSignal3SignalOptions) error

	// SomeSignal3 is a signal.
	SomeSignal3Async(workflow.Context, *simple.SomeSignal3Request, ...*simplexns.SomeSignal3SignalOptions) (simplexns.SomeSignal3SignalHandle, error)
}
...
// SetFooProgress sets the current status of a CreateFoo operation
func (r *provisionFooRun) SetFooProgress(ctx workflow.Context, req *v1.SetFooProgressRequest, opts ...*SetFooProgressSignalOptions) error {
	return SetFooProgress(ctx, r.ID(), "", req, opts...)
}

// SetFooProgress sets the current status of a CreateFoo operation
func (r *provisionFooRun) SetFooProgressAsync(ctx workflow.Context, req *v1.SetFooProgressRequest, opts ...*SetFooProgressSignalOptions) (SetFooProgressSignalHandle, error) {
	return SetFooProgressAsync(ctx, r.ID(), "", req, opts...)
}

// SomeSignal3 is a signal.
func (r *provisionFooRun) SomeSignal3(ctx workflow.Context, req *simple.SomeSignal3Request, opts ...*simplexns.SomeSignal3SignalOptions) error {
	return simplexns.SomeSignal3(ctx, r.ID(), "", req, opts...)
}

// SomeSignal3 is a signal.
func (r *provisionFooRun) SomeSignal3Async(ctx workflow.Context, req *simple.SomeSignal3Request, opts ...*simplexns.SomeSignal3SignalOptions) (simplexns.SomeSignal3SignalHandle, error) {
	return simplexns.SomeSignal3Async(ctx, r.ID(), "", req, opts...)
}
...
func ProvisionFooAsync(ctx workflow.Context, req *v1.ProvisionFooInput, opts ...*ProvisionFooWorkflowOptions) (ProvisionFooRun, error) {
	...
	if wo.ID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			...
			if err != nil {
				workflow.GetLogger(ctx).Error("error evaluating id expression for \"example.v1.External.ProvisionFoo\" workflow", "error", err)
				return nil
			}
			return id
		}).Get(&wo.ID); err != nil {
