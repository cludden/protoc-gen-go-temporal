...
func (c *exampleClient) UpdateFooProgress(ctx context.Context, workflowID string, runID string, req *SetFooProgressRequest, opts ...*UpdateFooProgressOptions) (*GetFooProgressResponse, error) {
	...
	handle, err := c.UpdateFooProgressAsync(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
func (o *UpdateFooProgressOptions) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *UpdateFooProgressOptions {
	o.waitPolicy = policy
	return o
}
