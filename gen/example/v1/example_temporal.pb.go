...
// =============================================================================
// Test Client (example.v1.Example)
// =============================================================================
...
// =============================================================================
// Nexus (example.v1.Example)
// =============================================================================

// ExampleServiceName defines the fully-qualified Example nexus service name
const ExampleServiceName = "example.v1.Example"

// RegisterExampleOperations registers all example.v1.Example nexus operations with the given service
func RegisterExampleOperations(svc *nexus.Service) error {
	return svc.Register(
		CreateFooWorkflowOperation,
	)
}

// RegisterExampleService registers a example.v1.Example nexus service with a given worker
func RegisterExampleService(r worker.NexusServiceRegistry) error {
	svc := nexus.NewService(ExampleServiceName)
	if err := RegisterExampleOperations(svc); err != nil {
		return err
	}
...
// CreateFooWorkflowOperationName defines the fully-qualified name for a example.v1.Example.CreateFoo nexus workflow operation
const CreateFooWorkflowOperationName = "CreateFoo"

// CreateFooWorkflowOperation defines a(n) example.v1.Example.CreateFoo nexus workflow operation
var CreateFooWorkflowOperation = temporalnexus.MustNewWorkflowRunOperationWithOptions(
	temporalnexus.WorkflowRunOperationOptions[*CreateFooRequest, *CreateFooResponse]{
		Name: CreateFooWorkflowOperationName,
		Handler: func(ctx context.Context, input *CreateFooRequest, opts nexus.StartOperationOptions) (temporalnexus.WorkflowHandle[*CreateFooResponse], error) {
			o, err := NewCreateFooOptions().Build(input.ProtoReflect())
			if err != nil {
				return nil, err
			}
			return temporalnexus.ExecuteUntypedWorkflow[*CreateFooResponse](ctx, opts, o, CreateFooWorkflowName, input)
		},
	},
)

// CreateFooWorkflowOperationFuture describes a handle to an asynchronous example.v1.Example.CreateFoo nexus workflow operation
type CreateFooWorkflowOperationFuture interface {
...
// createFooWorkflowOperationFuture provides an internal CreateFooWorkflowOperationFuture implementation
type createFooWorkflowOperationFuture struct {
	f workflow.NexusOperationFuture
}

// Future returns the underlying NexusOperationFuture
func (f *createFooWorkflowOperationFuture) Future() workflow.NexusOperationFuture {
	return f.f
}

// Get blocks until the nexus operation is complete, returning the result or error
func (f *createFooWorkflowOperationFuture) Get(ctx workflow.Context) (*CreateFooResponse, error) {
	var out CreateFooResponse
	return &out, f.f.Get(ctx, &out)
}

// CreateFooWorkflowOperationOptions provides methods for configuration a(n) example.v1.Example.CreateFoo nexus workflow operation
type CreateFooWorkflowOperationOptions struct {
	opts                   *workflow.NexusOperationOptions
	scheduleToCloseTimeout *durationpb.Duration
}

// NewCreateFooWorkflowOperationOptions initializes a new CreateFooWorkflowOperationOptions value
func NewCreateFooWorkflowOperationOptions() *CreateFooWorkflowOperationOptions {
	return &CreateFooWorkflowOperationOptions{}
}

// Build converts a(n) CreateFooWorkflowOperationOptions value into a workflow.NexusOperationOptions value
func (o *CreateFooWorkflowOperationOptions) Build(ctx workflow.Context) (workflow.NexusOperationOptions, error) {
...
func (o *CreateFooWorkflowOperationOptions) WithOptions(opts workflow.NexusOperationOptions) *CreateFooWorkflowOperationOptions {
	o.opts = &opts
	return o
}

// WithScheduleToCloseTimeout overrides the default ScheduleToCloseTimeout
func (o *CreateFooWorkflowOperationOptions) WithScheduleToCloseTimeout(d time.Duration) *CreateFooWorkflowOperationOptions {
	o.scheduleToCloseTimeout = durationpb.New(d)
	return o
}

// ExampleNexusClient describes a(n) example.v1.Example nexus client
type ExampleNexusClient interface {
	// CreateFoo creates a new foo operation
	CreateFoo(ctx workflow.Context, input *CreateFooRequest, options ...*CreateFooWorkflowOperationOptions) (*CreateFooResponse, error)
	// CreateFoo creates a new foo operation
	CreateFooAsync(ctx workflow.Context, input *CreateFooRequest, options ...*CreateFooWorkflowOperationOptions) CreateFooWorkflowOperationFuture
}

// exampleNexusClient provides an internal ExampleNexusClient implementation
type exampleNexusClient struct {
	client workflow.NexusClient
}

// NewExampleNexusClient initializes a new example.v1.Example nexus client
func NewExampleNexusClient(endpoint string) ExampleNexusClient {
	return &exampleNexusClient{
		client: workflow.NewNexusClient(endpoint, ExampleServiceName),
	}
}

// CreateFoo creates a new foo operation
func (c *exampleNexusClient) CreateFoo(ctx workflow.Context, input *CreateFooRequest, options ...*CreateFooWorkflowOperationOptions) (*CreateFooResponse, error) {
	return c.CreateFooAsync(ctx, input, options...).Get(ctx)
}

// CreateFoo creates a new foo operation
func (c *exampleNexusClient) CreateFooAsync(ctx workflow.Context, input *CreateFooRequest, options ...*CreateFooWorkflowOperationOptions) CreateFooWorkflowOperationFuture {
	var o *CreateFooWorkflowOperationOptions
	if len(options) > 0 && options[0] != nil {
		o = options[0]
	}
	...
	if err != nil {
		return &createFooWorkflowOperationFuture{
			f: errs.NewNexusOperationFutureError(err),
		}
	}

	return &createFooWorkflowOperationFuture{
		f: c.client.ExecuteOperation(ctx, CreateFooWorkflowOperationName, input, opts),
	}
}
