...
type ExampleClient interface {
	...
	// example.v1.Example.UpdateFooProgress retrieves a handle to an existing example.v1.Example.UpdateFooProgress update
...
func NewExternalClient(c client.Client, options ...*externalClientOptions) ExternalClient {
	var cfg *externalClientOptions
	if len(options) > 0 {
		cfg = options[0]
	} else {
		cfg = NewExternalClientOptions()
	}
...
func NewExternalClientWithOptions(c client.Client, opts client.Options, options ...*externalClientOptions) (ExternalClient, error) {
	var err error
	c, err = client.NewClientFromExisting(c, opts)
	if err != nil {
		return nil, fmt.Errorf("error initializing client with options: %w", err)
...
// externalClientOptions describes optional runtime configuration for a ExternalClient
type externalClientOptions struct {
	log *slog.Logger
}

// NewExternalClientOptions initializes a new externalClientOptions value
func NewExternalClientOptions() *externalClientOptions {
	return &externalClientOptions{}
}

// WithLogger can be used to override the default logger
func (opts *externalClientOptions) WithLogger(l *slog.Logger) *externalClientOptions {
	if l != nil {
		opts.log = l
	}
	return opts
...
// getLogger returns the configured logger, or the default logger
func (opts *externalClientOptions) getLogger() *slog.Logger {
	if opts != nil && opts.log != nil {
		return opts.log
	}
	return slog.Default()
...
// example.v1.External.ProvisionFoo executes a example.v1.External.ProvisionFoo workflow and blocks until error or response received
...
// ProvisionFooAsync starts a(n) example.v1.External.ProvisionFoo workflow and returns a handle to the workflow run
...
type ProvisionFooRun interface {
	...
	SomeSignal3(ctx context.Context, req *simple.SomeSignal3Request) error
}
...
// SetFooProgress sets the current status of a CreateFoo operation
func (r *provisionFooRun) SetFooProgress(ctx context.Context, req *SetFooProgressRequest) error {
	return r.client.client.SignalWorkflow(ctx, r.ID(), r.RunID(), SetFooProgressSignalName, req)
}

// SomeSignal3 is a signal.
func (r *provisionFooRun) SomeSignal3(ctx context.Context, req *simple.SomeSignal3Request) error {
	return r.client.client.SignalWorkflow(ctx, r.ID(), r.RunID(), simple.SomeSignal3SignalName, req)
}
...
type ExternalWorkflows interface {
	// example.v1.External.ProvisionFoo initializes a new a(n) ProvisionFooWorkflow implementation
...
func buildProvisionFoo(ctor func(workflow.Context, *ProvisionFooWorkflowInput) (ProvisionFooWorkflow, error)) func(workflow.Context, *ProvisionFooInput) (*ProvisionFooResponse, error) {
	return func(ctx workflow.Context, req *ProvisionFooInput) (*ProvisionFooResponse, error) {
		input := &ProvisionFooWorkflowInput{
			...
			SomeSignal3: &simple.SomeSignal3Signal{
				Channel: workflow.GetSignalChannel(ctx, simple.SomeSignal3SignalName),
			},
		}
		wf, err := ctor(ctx, input)
		if err != nil {
...
// ProvisionFooChild executes a child example.v1.External.ProvisionFoo workflow and blocks until error or response received
...
// ProvisionFooChildAsync starts a child example.v1.External.ProvisionFoo workflow and returns a handle to the child workflow run
...
// SetFooProgress sends a(n) "example.v1.Example.SetFooProgress" signal request to the child workflow
func (r *ProvisionFooChildRun) SetFooProgress(ctx workflow.Context, input *SetFooProgressRequest) error {
	return r.SetFooProgressAsync(ctx, input).Get(ctx, nil)
}

// SetFooProgressAsync sends a(n) "example.v1.Example.SetFooProgress" signal request to the child workflow
func (r *ProvisionFooChildRun) SetFooProgressAsync(ctx workflow.Context, input *SetFooProgressRequest) workflow.Future {
	return r.Future.SignalChildWorkflow(ctx, SetFooProgressSignalName, input)
}

// SomeSignal3 sends a(n) "mycompany.simple.Simple.SomeSignal3" signal request to the child workflow
func (r *ProvisionFooChildRun) SomeSignal3(ctx workflow.Context, input *simple.SomeSignal3Request) error {
	return r.SomeSignal3Async(ctx, input).Get(ctx, nil)
}

// SomeSignal3Async sends a(n) "mycompany.simple.Simple.SomeSignal3" signal request to the child workflow
func (r *ProvisionFooChildRun) SomeSignal3Async(ctx workflow.Context, input *simple.SomeSignal3Request) workflow.Future {
	return r.Future.SignalChildWorkflow(ctx, simple.SomeSignal3SignalName, input)
}
...
// ProvisionFoo executes a(n) example.v1.External.ProvisionFoo workflow in the test environment
...
// ProvisionFooAsync executes a(n) example.v1.External.ProvisionFoo workflow in the test environment
...
// testProvisionFooRun provides convenience methods for interacting with a(n) example.v1.External.ProvisionFoo workflow in the test environment
...
// Get retrieves a test example.v1.External.ProvisionFoo workflow result
...
// ID returns a test example.v1.External.ProvisionFoo workflow run's workflow ID
...
// SetFooProgress executes a example.v1.Example.SetFooProgress signal against a test example.v1.External.ProvisionFoo workflow
func (r *testProvisionFooRun) SetFooProgress(ctx context.Context, req *SetFooProgressRequest) error {
	r.env.SignalWorkflow(SetFooProgressSignalName, req)
	return nil
}

// SomeSignal3 executes a mycompany.simple.Simple.SomeSignal3 signal against a test example.v1.External.ProvisionFoo workflow
func (r *testProvisionFooRun) SomeSignal3(ctx context.Context, req *simple.SomeSignal3Request) error {
	r.env.SignalWorkflow(simple.SomeSignal3SignalName, req)
	return nil
}
...
func newExternalCommands(options ...*ExternalCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		// example.v1.External.ProvisionFoo executes a(n) example.v1.External.ProvisionFoo workflow,
		{
			Name:                   "provision-foo",
			Usage:                  "example.v1.External.ProvisionFoo executes a(n) example.v1.External.ProvisionFoo workflow",
			Category:               "WORKFLOWS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
...
func WithExternalSchemeTypes() scheme.Option {
	return func(s *scheme.Scheme) {
		...
		s.RegisterType(File_example_v1_example_proto.Messages().ByName("ProvisionFooResponse"))
	}
}
