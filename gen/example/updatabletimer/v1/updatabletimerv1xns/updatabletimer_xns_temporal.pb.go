...
type UpdatableTimerRun interface {
	...
	// GetWakeUpTime executes a(n) example.updatabletimer.v1.Example.GetWakeUpTime query and blocks until completion
	GetWakeUpTime(workflow.Context, ...*GetWakeUpTimeQueryOptions) (*v1.GetWakeUpTimeOutput, error)

	// GetWakeUpTimeAsync executes a(n) example.updatabletimer.v1.Example.GetWakeUpTime query and returns a handle to the underlying activity
	GetWakeUpTimeAsync(workflow.Context, ...*GetWakeUpTimeQueryOptions) (GetWakeUpTimeQueryHandle, error)

	// UpdateWakeUpTime executes a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal and blocks until completion
	UpdateWakeUpTime(workflow.Context, *v1.UpdateWakeUpTimeInput, ...*UpdateWakeUpTimeSignalOptions) error

	// UpdateWakeUpTimeAsync executes a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal and returns a handle to the underlying activity
...
// UpdateWakeUpTime executes a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal and blocks until the underlying activity completes
...
// UpdatableTimerAsync executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow and blocks until error or response received
...
// GetWakeUpTime executes a(n) example.updatabletimer.v1.Example.GetWakeUpTime query and blocks until error or response received
...
// UpdateWakeUpTime executes a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal
...
// UpdatableTimer executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow via an activity
