...
func file_example_updatabletimer_v1_updatabletimer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_example_updatabletimer_v1_updatabletimer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_example_updatabletimer_v1_updatabletimer_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_example_updatabletimer_v1_updatabletimer_proto_msgTypes[2].Exporter = func(v any, i int) any {
