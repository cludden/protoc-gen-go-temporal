	...
	commands := []*v2.Command{
		...
		},
		{
			...
			Flags: []v2.Flag{
				...
				&v2.TimestampFlag{
					Name:     "wake-up-time",
					Usage:    "set the value of the operation's \"WakeUpTime\" parameter",
					Category: "INPUT",
		...
		},
		{
			...
			Flags: []v2.Flag{
				...
				&v2.TimestampFlag{
					...
					Usage:    "set the value of the operation's \"InitialWakeUpTime\" parameter",
					Category: "INPUT",
					Layout:   time.RFC3339Nano,
				},
				&v2.StringFlag{
...
func UnmarshalCliFlagsToUpdateWakeUpTimeInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*UpdateWakeUpTimeInput, error) {
	...
	if cmd.IsSet("wake-up-time") {
		hasValues = true
		v := cmd.Timestamp(opts.FlagName("wake-up-time"))
...
func UnmarshalCliFlagsToUpdatableTimerInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*UpdatableTimerInput, error) {
	...
	if cmd.IsSet("initial-wake-up-time") {
		hasValues = true
		v := cmd.Timestamp(opts.FlagName("initial-wake-up-time"))
		value := timestamppb.New(*v)
