...
const (
	UpdatableTimerWorkflowName = "example.updatabletimer.v1.Example.UpdatableTimer"
)
...
type ExampleClient interface {
	// UpdatableTimer executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow and blocks until error or response received
	UpdatableTimer(ctx context.Context, req *UpdatableTimerInput, opts ...*UpdatableTimerOptions) error

	// UpdatableTimerAsync starts a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow and returns a handle to the workflow run
	UpdatableTimerAsync(ctx context.Context, req *UpdatableTimerInput, opts ...*UpdatableTimerOptions) (UpdatableTimerRun, error)

	// GetUpdatableTimer retrieves a handle to an existing example.updatabletimer.v1.Example.UpdatableTimer workflow execution
	...
	// example.updatabletimer.v1.Example.GetWakeUpTime executes a(n) example.updatabletimer.v1.Example.GetWakeUpTime query
	GetWakeUpTime(ctx context.Context, workflowID string, runID string) (*GetWakeUpTimeOutput, error)

	// example.updatabletimer.v1.Example.UpdateWakeUpTime sends a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal
...
// example.updatabletimer.v1.Example.UpdatableTimer executes a example.updatabletimer.v1.Example.UpdatableTimer workflow and blocks until error or response received
...
// GetUpdatableTimer fetches an existing example.updatabletimer.v1.Example.UpdatableTimer execution
...
// example.updatabletimer.v1.Example.GetWakeUpTime sends a(n) example.updatabletimer.v1.Example.GetWakeUpTime query to an existing workflow
...
// example.updatabletimer.v1.Example.UpdateWakeUpTime sends a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal to an existing workflow
...
// UpdatableTimerOptions provides configuration for a example.updatabletimer.v1.Example.UpdatableTimer workflow operation
...
// UpdatableTimerRun describes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow run
...
var (
	// UpdatableTimerFunction implements a "UpdatableTimerWorkflow" workflow
...
type ExampleWorkflows interface {
	// example.updatabletimer.v1.Example.UpdatableTimer initializes a new a(n) UpdatableTimerWorkflow implementation
...
// UpdatableTimerWorkflowInput describes the input to a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow constructor
type UpdatableTimerWorkflowInput struct {
	Req              *UpdatableTimerInput
	UpdateWakeUpTime *UpdateWakeUpTimeSignal
}

// UpdatableTimerWorkflow describes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow implementation
//
// workflow details: (id: "updatable-timer/${! name.or(uuid_v4()) }")
type UpdatableTimerWorkflow interface {
	// Execute defines the entrypoint to a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow
	Execute(ctx workflow.Context) error

	// example.updatabletimer.v1.Example.GetWakeUpTime implements a(n) example.updatabletimer.v1.Example.GetWakeUpTime query handler
	GetWakeUpTime() (*GetWakeUpTimeOutput, error)
}

// UpdatableTimerChild executes a child example.updatabletimer.v1.Example.UpdatableTimer workflow and blocks until error or response received
...
// UpdatableTimerChildAsync starts a child example.updatabletimer.v1.Example.UpdatableTimer workflow and returns a handle to the child workflow run
...
// UpdatableTimerChildOptions provides configuration for a example.updatabletimer.v1.Example.UpdatableTimer workflow operation
...
// UpdateWakeUpTimeExternal sends a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal to an existing workflow
...
// UpdateWakeUpTimeExternalAsync sends a(n) example.updatabletimer.v1.Example.UpdateWakeUpTime signal to an existing workflow
...
// UpdatableTimer executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow in the test environment
...
// UpdatableTimerAsync executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow in the test environment
...
// testUpdatableTimerRun provides convenience methods for interacting with a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow in the test environment
...
// Get retrieves a test example.updatabletimer.v1.Example.UpdatableTimer workflow result
...
// ID returns a test example.updatabletimer.v1.Example.UpdatableTimer workflow run's workflow ID
...
// GetWakeUpTime executes a example.updatabletimer.v1.Example.GetWakeUpTime query against a test example.updatabletimer.v1.Example.UpdatableTimer workflow
...
// UpdateWakeUpTime executes a example.updatabletimer.v1.Example.UpdateWakeUpTime signal against a test example.updatabletimer.v1.Example.UpdatableTimer workflow
...
func newExampleCommands(options ...*ExampleCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		// executes a example.updatabletimer.v1.Example.GetWakeUpTime query and blocks until error or response received,
		{
			Name:                   "get-wake-up-time",
			Usage:                  "executes a example.updatabletimer.v1.Example.GetWakeUpTime query and blocks until error or response received",
			Category:               "QUERIES",
		...
		// executes a example.updatabletimer.v1.Example.UpdateWakeUpTime signal,
		{
			Name:                   "update-wake-up-time",
			Usage:                  "executes a example.updatabletimer.v1.Example.UpdateWakeUpTime signal",
			Category:               "SIGNALS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
		...
		// example.updatabletimer.v1.Example.UpdatableTimer executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow,
		{
			Name:                   "updatable-timer",
			Usage:                  "example.updatabletimer.v1.Example.UpdatableTimer executes a(n) example.updatabletimer.v1.Example.UpdatableTimer workflow",
			Category:               "WORKFLOWS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
