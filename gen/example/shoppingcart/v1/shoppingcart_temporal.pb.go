	...
	commands := []*v2.Command{
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				req, err := UnmarshalCliFlagsToDescribeInput(cmd)
				if err != nil {
		...
		},
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				defer c.Close()
				client := NewShoppingCartClient(c)
				req, err := UnmarshalCliFlagsToCheckoutInput(cmd)
				if err != nil {
					return fmt.Errorf("error unmarshalling request: %w", err)
				}
		...
		},
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				defer c.Close()
				client := NewShoppingCartClient(c)
				req, err := UnmarshalCliFlagsToUpdateCartInput(cmd)
				if err != nil {
					return fmt.Errorf("error unmarshalling request: %w", err)
				}
		...
		},
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				req, err := UnmarshalCliFlagsToShoppingCartInput(cmd)
				if err != nil {
					return fmt.Errorf("error unmarshalling request: %w", err)
				}
				opts := client.StartWorkflowOptions{}
