...
func UnmarshalCliFlagsToFooInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*FooInput, error) {
	...
	if cmd.IsSet("optional-bytes") {
		hasValues = true
		value, err := base64.StdEncoding.DecodeString(cmd.String(opts.FlagName("optional-bytes")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-bool") {
		hasValues = true
		value := cmd.Bool(opts.FlagName("optional-bool"))
		result.OptionalBool = &value
	}
	if cmd.IsSet("optional-double") {
		hasValues = true
		value := cmd.Float64(opts.FlagName("optional-double"))
		result.OptionalDouble = &value
	}
	if cmd.IsSet("optional-fixed-32") {
		hasValues = true
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(opts.FlagName("optional-fixed-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-fixed-64") {
		hasValues = true
		value := cmd.Uint64(opts.FlagName("optional-fixed-64"))
		result.OptionalFixed64 = &value
	}
	if cmd.IsSet("optional-float") {
		hasValues = true
		value, err := convert.SafeCast[float64, float32](cmd.Float64(opts.FlagName("optional-float")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-int-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("optional-int-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-int-64") {
		hasValues = true
		value := cmd.Int64(opts.FlagName("optional-int-64"))
		result.OptionalInt64 = &value
	}
	if cmd.IsSet("optional-sfixed-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("optional-sfixed-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-sfixed-64") {
		hasValues = true
		value := cmd.Int64(opts.FlagName("optional-sfixed-64"))
		result.OptionalSfixed64 = &value
	}
	if cmd.IsSet("optional-sint-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("optional-sint-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-sint-64") {
		hasValues = true
		value := cmd.Int64(opts.FlagName("optional-sint-64"))
		result.OptionalSint64 = &value
	}
	if cmd.IsSet("optional-string") {
		hasValues = true
		value := cmd.String(opts.FlagName("optional-string"))
		result.OptionalString = &value
	}
	if cmd.IsSet("optional-uint-32") {
		hasValues = true
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(opts.FlagName("optional-uint-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("optional-uint-64") {
		hasValues = true
		value := cmd.Uint64(opts.FlagName("optional-uint-64"))
