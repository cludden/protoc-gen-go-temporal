...
const (
	FooWorkflowName = "test.proto3optional.FooService.Foo"
)

// test.proto3optional.FooService activity names
const (
	FooActivityName = "test.proto3optional.FooService.Foo"
)

// FooServiceClient describes a client for a(n) test.proto3optional.FooService worker
type FooServiceClient interface {
	// Foo executes a(n) test.proto3optional.FooService.Foo workflow and blocks until error or response received
	Foo(ctx context.Context, req *FooInput, opts ...*FooOptions) (*FooOutput, error)

	// FooAsync starts a(n) test.proto3optional.FooService.Foo workflow and returns a handle to the workflow run
	FooAsync(ctx context.Context, req *FooInput, opts ...*FooOptions) (FooRun, error)

	// GetFoo retrieves a handle to an existing test.proto3optional.FooService.Foo workflow execution
...
// fooServiceClient implements a temporal client for a test.proto3optional.FooService service
type fooServiceClient struct {
	client client.Client
	log    *slog.Logger
}

// NewFooServiceClient initializes a new test.proto3optional.FooService client
...
// test.proto3optional.FooService.Foo executes a test.proto3optional.FooService.Foo workflow and blocks until error or response received
...
// GetFoo fetches an existing test.proto3optional.FooService.Foo execution
...
// FooOptions provides configuration for a test.proto3optional.FooService.Foo workflow operation
...
func (o *FooOptions) WithPriority(priority temporal.Priority) *FooOptions {
	o.priority = &priority
	return o
}
...
func (o *FooOptions) WithPriorityKey(priorityKey int) *FooOptions {
...
func (o *FooOptions) WithFairnessKey(fairnessKey string) *FooOptions {
...
func (o *FooOptions) WithFairnessWeight(fairnessWeight float32) *FooOptions {
...
func (o *FooOptions) WithVersioningOverride(versioningOverride client.VersioningOverride) *FooOptions {
...
// FooRun describes a(n) test.proto3optional.FooService.Foo workflow run
...
var (
	// fooServiceRegistrationMutex is a mutex for registering test.proto3optional.FooService workflows
	fooServiceRegistrationMutex sync.Mutex
	// FooFunction implements a "test.proto3optional.FooService.Foo" workflow
...
type (
	...
	FooServiceWorkflowFunctions interface {
		// Foo executes a "test.proto3optional.FooService.Foo" workflow inline
...
// FooServiceWorkflows provides methods for initializing new test.proto3optional.FooService workflow values
...
// RegisterFooServiceWorkflows registers test.proto3optional.FooService workflows with the given worker
...
// RegisterFooWorkflow registers a test.proto3optional.FooService.Foo workflow with the given worker
...
// FooWorkflowInput describes the input to a(n) test.proto3optional.FooService.Foo workflow constructor
...
// FooWorkflow describes a(n) test.proto3optional.FooService.Foo workflow implementation
type FooWorkflow interface {
	// Execute defines the entrypoint to a(n) test.proto3optional.FooService.Foo workflow
	Execute(ctx workflow.Context) (*FooOutput, error)
}

// FooChild executes a child test.proto3optional.FooService.Foo workflow and blocks until error or response received
...
// FooChildAsync starts a child test.proto3optional.FooService.Foo workflow and returns a handle to the child workflow run
...
// FooChildOptions provides configuration for a child test.proto3optional.FooService.Foo workflow operation
...
// WithPriority sets the Priority value
func (o *FooChildOptions) WithPriority(priority temporal.Priority) *FooChildOptions {
	o.priority = &priority
	return o
}

// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *FooChildOptions) WithPriorityKey(priorityKey int) *FooChildOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *FooChildOptions) WithFairnessKey(fairnessKey string) *FooChildOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *FooChildOptions) WithFairnessWeight(fairnessWeight float32) *FooChildOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
...
type FooServiceActivities interface {
	// test.proto3optional.FooService.Foo implements a(n) test.proto3optional.FooService.Foo activity definition
...
// RegisterFooActivity registers a test.proto3optional.FooService.Foo activity
...
// FooFuture describes a(n) test.proto3optional.FooService.Foo activity execution
...
// Foo executes a(n) test.proto3optional.FooService.Foo activity
...
// FooAsync executes a(n) test.proto3optional.FooService.Foo activity (asynchronously)
...
// FooLocal executes a(n) test.proto3optional.FooService.Foo activity (locally)
...
// FooLocalAsync executes a(n) test.proto3optional.FooService.Foo activity (asynchronously, locally)
...
// FooActivityOptions provides configuration for a(n) test.proto3optional.FooService.Foo activity
...
// WithPriorityKey sets the Priority.PriorityKey value, overriding any schema default while leaving other Priority fields intact
func (o *FooActivityOptions) WithPriorityKey(priorityKey int) *FooActivityOptions {
	o.priorityKey = &priorityKey
	return o
}

// WithFairnessKey sets the Priority.FairnessKey value, overriding any schema default while leaving other Priority fields intact
func (o *FooActivityOptions) WithFairnessKey(fairnessKey string) *FooActivityOptions {
	o.fairnessKey = &fairnessKey
	return o
}

// WithFairnessWeight sets the Priority.FairnessWeight value, overriding any schema default while leaving other Priority fields intact
func (o *FooActivityOptions) WithFairnessWeight(fairnessWeight float32) *FooActivityOptions {
	o.fairnessWeight = &fairnessWeight
	return o
}
...
// FooLocalActivityOptions provides configuration for a(n) test.proto3optional.FooService.Foo activity
...
// Local specifies a custom test.proto3optional.FooService.Foo implementation
...
// Foo executes a(n) test.proto3optional.FooService.Foo workflow in the test environment
...
// FooAsync executes a(n) test.proto3optional.FooService.Foo workflow in the test environment
...
// testFooRun provides convenience methods for interacting with a(n) test.proto3optional.FooService.Foo workflow in the test environment
...
// Get retrieves a test test.proto3optional.FooService.Foo workflow result
...
// ID returns a test test.proto3optional.FooService.Foo workflow run's workflow ID
...
// FooServiceCliOptions describes runtime configuration for test.proto3optional.FooService cli
...
// NewFooServiceCli initializes a cli for a(n) test.proto3optional.FooService service
func NewFooServiceCli(options ...*FooServiceCliOptions) (*v2.App, error) {
	...
	return &v2.App{
		Name:                      "foo-service",
		Usage:                     "test.proto3optional.FooService operations",
		Commands:                  commands,
		DisableSliceFlagSeparator: true,
	}, nil
}

// NewFooServiceCliCommand initializes a cli command for a test.proto3optional.FooService service with subcommands for each query, signal, update, and workflow
...
// newFooServiceCommands initializes (sub)commands for a test.proto3optional.FooService cli or command
func newFooServiceCommands(options ...*FooServiceCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		{
			Name:                   "foo",
			Usage:                  "executes a(n) test.proto3optional.FooService.Foo workflow",
			Category:               "WORKFLOWS",
	...
	if opts.worker != nil {
		commands = append(commands, []*v2.Command{
			{
				Name:                   "worker",
				Usage:                  "runs a test.proto3optional.FooService worker process",
				UseShortOptionHandling: true,
				Before:                 opts.before,
				After:                  opts.after,
				Action: func(cmd *v2.Context) error {
...
func UnmarshalCliFlagsToFooInput(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*FooInput, error) {
	...
	if flag := opts.FlagName("optional-bool"); cmd.IsSet(flag) {
		value := cmd.Bool(flag)
		result.OptionalBool = &value
	}
	if flag := opts.FlagName("optional-double"); cmd.IsSet(flag) {
		value := cmd.Float64(flag)
		result.OptionalDouble = &value
	}
	if flag := opts.FlagName("optional-fixed-32"); cmd.IsSet(flag) {
	...
	if flag := opts.FlagName("optional-fixed-64"); cmd.IsSet(flag) {
		value := cmd.Uint64(flag)
		result.OptionalFixed64 = &value
	}
	if flag := opts.FlagName("optional-float"); cmd.IsSet(flag) {
	...
	if flag := opts.FlagName("optional-int-32"); cmd.IsSet(flag) {
	...
	if flag := opts.FlagName("optional-int-64"); cmd.IsSet(flag) {
		value := cmd.Int64(flag)
		result.OptionalInt64 = &value
	}
	if flag := opts.FlagName("optional-sfixed-32"); cmd.IsSet(flag) {
		value, err := convert.SafeCast[int64, int32](cmd.Int64(flag))
		if err != nil {
			return nil, err
		}
	...
	if flag := opts.FlagName("optional-sfixed-64"); cmd.IsSet(flag) {
		value := cmd.Int64(flag)
		result.OptionalSfixed64 = &value
	}
	if flag := opts.FlagName("optional-sint-32"); cmd.IsSet(flag) {
		value, err := convert.SafeCast[int64, int32](cmd.Int64(flag))
		if err != nil {
			return nil, err
		}
	...
	if flag := opts.FlagName("optional-sint-64"); cmd.IsSet(flag) {
		value := cmd.Int64(flag)
		result.OptionalSint64 = &value
	}
	if flag := opts.FlagName("optional-string"); cmd.IsSet(flag) {
		value := cmd.String(flag)
		result.OptionalString = &value
	}
	if flag := opts.FlagName("optional-uint-32"); cmd.IsSet(flag) {
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(flag))
		if err != nil {
			return nil, err
		}
	...
	if flag := opts.FlagName("optional-uint-64"); cmd.IsSet(flag) {
		value := cmd.Uint64(flag)
...
func WithFooServiceSchemeTypes() scheme.Option {
	return func(s *scheme.Scheme) {
		s.RegisterType(File_test_proto3optional_example_proto.Messages().ByName("FooInput"))
		s.RegisterType(File_test_proto3optional_example_proto.Messages().ByName("FooOutput"))
	}
}
