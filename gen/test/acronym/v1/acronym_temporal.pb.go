...
func UnmarshalCliFlagsToManageAWSResourceRequest(cmd *v2.Context) (*ManageAWSResourceRequest, error) {
	...
	if cmd.IsSet("k8-snamespace") {
		hasValues = true
		result.K8SNamespace = cmd.String("k8-snamespace")
	}
	if !hasValues {
		return nil, nil
	}
...
func UnmarshalCliFlagsToSomethingV1FooBarRequest(cmd *v2.Context) (*SomethingV1FooBarRequest, error) {
...
func UnmarshalCliFlagsToSomethingV2FooBarRequest(cmd *v2.Context) (*SomethingV2FooBarRequest, error) {
