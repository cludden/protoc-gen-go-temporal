...
var (
	...
	ManageAWSResourceIDExpression = expression.MustParseExpression("manage-aws-resource/${! uuid_v4() }")
)
...
// ManageAWS does some workflow thing.
//
// workflow details: (name: "mycompany.initialism.AWS.ManageAWS", id: "manage-aws/${! urn }/${! uuid_v4() }")
...
// ManageAWSResource does some workflow thing.
//
// workflow details: (name: "mycompany.initialism.AWS.ManageAWSResource", id: "manage-aws-resource/${! uuid_v4() }")
