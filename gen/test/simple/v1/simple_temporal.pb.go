...
func (c *simpleClient) SomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*SomeUpdate1Options) (*SomeUpdate1Response, error) {
	...
	handle, err := c.SomeUpdate1Async(ctx, workflowID, runID, req, o.WithWaitPolicy(v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
func (o *SomeWorkflow1Options) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow1Options {
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow2Options) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow2Options {
	o.idReusePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow3Options) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow3Options {
	o.idReusePolicy = policy
	return o
}
...
func (o *SomeUpdate1Options) Build(workflowID string, runID string, req *SomeUpdate1Request) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
	...
	} else if opts.WaitPolicy.GetLifecycleStage() == v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_UNSPECIFIED {
		opts.WaitPolicy = &v11.WaitPolicy{LifecycleStage: v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED}
	}
	return opts, nil
}
...
func (o *SomeUpdate1Options) WithUpdateWorkflowOptions(options client.UpdateWorkflowWithOptionsRequest) *SomeUpdate1Options {
	o.Options = &options
	return o
}

// WithWaitPolicy sets the WaitPolicy
func (o *SomeUpdate1Options) WithWaitPolicy(policy v1.UpdateWorkflowExecutionLifecycleStage) *SomeUpdate1Options {
	o.waitPolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow1ChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow1ChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow1ChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *SomeWorkflow1ChildOptions {
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow2ChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow2ChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow2ChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *SomeWorkflow2ChildOptions {
	o.parentClosePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow3ChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeWorkflow3ChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *SomeWorkflow3ChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *SomeWorkflow3ChildOptions {
	o.parentClosePolicy = policy
	return o
}
...
func (c *otherClient) OtherUpdate(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*OtherUpdateOptions) (*OtherUpdateResponse, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.OtherUpdateAsync(ctx, workflowID, runID, req, o.WithWaitPolicy(v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *OtherWorkflowOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *OtherWorkflowOptions {
	o.idReusePolicy = policy
	return o
}
...
// Build initializes a new client.UpdateWorkflowWithOptionsRequest with defaults and overrides applied
func (o *OtherUpdateOptions) Build(workflowID string, runID string, req *OtherUpdateRequest) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
	// use user-provided UpdateWorkflowWithOptionsRequest if exists
	if o.Options != nil {
		opts = o.Options
	} else {
...
// WithUpdateWorkflowOptions sets the initial client.UpdateWorkflowWithOptionsRequest
func (o *OtherUpdateOptions) WithUpdateWorkflowOptions(options client.UpdateWorkflowWithOptionsRequest) *OtherUpdateOptions {
	o.Options = &options
	return o
}

// WithWaitPolicy sets the WaitPolicy
func (o *OtherUpdateOptions) WithWaitPolicy(policy v1.UpdateWorkflowExecutionLifecycleStage) *OtherUpdateOptions {
	o.waitPolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *OtherWorkflowChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *OtherWorkflowChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *OtherWorkflowChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *OtherWorkflowChildOptions {
	o.parentClosePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *WhatOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *WhatOptions {
	o.idReusePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *WhatChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *WhatChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *WhatChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *WhatChildOptions {
	o.parentClosePolicy = policy
	return o
}
...
func (c *deprecatedClient) SomeDeprecatedUpdate1(ctx context.Context, workflowID string, runID string, req *SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1Options) (*SomeDeprecatedMessage, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.SomeDeprecatedUpdate1Async(ctx, workflowID, runID, req, o.WithWaitPolicy(v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
func (c *deprecatedClient) SomeDeprecatedUpdate2(ctx context.Context, workflowID string, runID string, req *SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2Options) (*SomeDeprecatedMessage, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.SomeDeprecatedUpdate2Async(ctx, workflowID, runID, req, o.WithWaitPolicy(v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow1Options) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeDeprecatedWorkflow1Options {
	o.idReusePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow2Options) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeDeprecatedWorkflow2Options {
	o.idReusePolicy = policy
	return o
}
...
// Build initializes a new client.UpdateWorkflowWithOptionsRequest with defaults and overrides applied
func (o *SomeDeprecatedUpdate1Options) Build(workflowID string, runID string, req *SomeDeprecatedMessage) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
	// use user-provided UpdateWorkflowWithOptionsRequest if exists
	if o.Options != nil {
		opts = o.Options
	} else {
...
// WithUpdateWorkflowOptions sets the initial client.UpdateWorkflowWithOptionsRequest
func (o *SomeDeprecatedUpdate1Options) WithUpdateWorkflowOptions(options client.UpdateWorkflowWithOptionsRequest) *SomeDeprecatedUpdate1Options {
	o.Options = &options
	return o
}

// WithWaitPolicy sets the WaitPolicy
func (o *SomeDeprecatedUpdate1Options) WithWaitPolicy(policy v1.UpdateWorkflowExecutionLifecycleStage) *SomeDeprecatedUpdate1Options {
	o.waitPolicy = policy
	return o
}
...
// Build initializes a new client.UpdateWorkflowWithOptionsRequest with defaults and overrides applied
func (o *SomeDeprecatedUpdate2Options) Build(workflowID string, runID string, req *SomeDeprecatedMessage) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
	// use user-provided UpdateWorkflowWithOptionsRequest if exists
	if o.Options != nil {
		opts = o.Options
	} else {
...
// WithUpdateWorkflowOptions sets the initial client.UpdateWorkflowWithOptionsRequest
func (o *SomeDeprecatedUpdate2Options) WithUpdateWorkflowOptions(options client.UpdateWorkflowWithOptionsRequest) *SomeDeprecatedUpdate2Options {
	o.Options = &options
	return o
}

// WithWaitPolicy sets the WaitPolicy
func (o *SomeDeprecatedUpdate2Options) WithWaitPolicy(policy v1.UpdateWorkflowExecutionLifecycleStage) *SomeDeprecatedUpdate2Options {
	o.waitPolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow1ChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeDeprecatedWorkflow1ChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow1ChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *SomeDeprecatedWorkflow1ChildOptions {
	o.parentClosePolicy = policy
	return o
}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow2ChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *SomeDeprecatedWorkflow2ChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *SomeDeprecatedWorkflow2ChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *SomeDeprecatedWorkflow2ChildOptions {
	o.parentClosePolicy = policy
	return o
}
