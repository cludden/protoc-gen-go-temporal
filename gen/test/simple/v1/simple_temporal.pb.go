...
func (c *simpleClient) SomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*SomeUpdate1Options) (*SomeUpdate1Response, error) {
	...
	handle, err := c.SomeUpdate1Async(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
type SomeUpdate1Options struct {
	...
	id         *string
	waitPolicy enumsv1.UpdateWorkflowExecutionLifecycleStage
}
...
func (o *SomeUpdate1Options) Build(workflowID string, runID string, req *SomeUpdate1Request) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
	...
	// set WaitPolicy
	if v := o.waitPolicy; v != enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_UNSPECIFIED {
		opts.WaitPolicy = &updatev1.WaitPolicy{LifecycleStage: v}
	} else if opts.WaitPolicy.GetLifecycleStage() == enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_UNSPECIFIED {
...
func (o *SomeUpdate1Options) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *SomeUpdate1Options {
	o.waitPolicy = policy
	return o
}
...
func (c *TestSimpleClient) SomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*SomeUpdate1Options) (*SomeUpdate1Response, error) {
	...
	options.Options.WaitPolicy = &updatev1.WaitPolicy{LifecycleStage: enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED}
...
func (c *otherClient) OtherUpdate(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*OtherUpdateOptions) (*OtherUpdateResponse, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.OtherUpdateAsync(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
// WithWaitPolicy sets the WaitPolicy
func (o *OtherUpdateOptions) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *OtherUpdateOptions {
	o.waitPolicy = policy
	return o
}
...
func (c *deprecatedClient) SomeDeprecatedUpdate1(ctx context.Context, workflowID string, runID string, req *SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1Options) (*SomeDeprecatedMessage, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.SomeDeprecatedUpdate1Async(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
func (c *deprecatedClient) SomeDeprecatedUpdate2(ctx context.Context, workflowID string, runID string, req *SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2Options) (*SomeDeprecatedMessage, error) {
	...
	// call sync update with UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED wait policy
	handle, err := c.SomeDeprecatedUpdate2Async(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return nil, err
	}
...
// WithWaitPolicy sets the WaitPolicy
func (o *SomeDeprecatedUpdate1Options) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *SomeDeprecatedUpdate1Options {
	o.waitPolicy = policy
	return o
}
...
// WithWaitPolicy sets the WaitPolicy
func (o *SomeDeprecatedUpdate2Options) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *SomeDeprecatedUpdate2Options {
	o.waitPolicy = policy
	return o
}
