...
func UnmarshalCliFlagsToSomeQuery2Request(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*SomeQuery2Request, error) {
	...
	if cmd.IsSet("request-val") {
		hasValues = true
		value := cmd.String(opts.FlagName("request-val"))
...
func UnmarshalCliFlagsToSomeWorkflow1Request(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*SomeWorkflow1Request, error) {
	...
	if cmd.IsSet("id") {
		hasValues = true
		value := cmd.String(opts.FlagName("id"))
		result.Id = value
	}
	if !hasValues {
		return nil, nil
...
func UnmarshalCliFlagsToPaginatedRequest(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*v1.PaginatedRequest, error) {
	...
	if cmd.IsSet("limit") {
		hasValues = true
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(opts.FlagName("limit")))
		if err != nil {
			return nil, err
		}
		result.Limit = value
	...
	if cmd.IsSet("cursor") {
		hasValues = true
		value, err := base64.StdEncoding.DecodeString(cmd.String(opts.FlagName("cursor")))
		if err != nil {
			return nil, err
		}
		result.Cursor = value
	...
	commands := []*v2.Command{
		...
		},
		{
			...
			Flags: []v2.Flag{
				...
				&v2.StringFlag{
					Name:     "baz",
					Usage:    "set the value of the operation's \"Baz\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "qux",
					Usage:    "set the value of the operation's \"Qux\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "foo",
					Usage:    "set the value of the operation's \"Foo\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "bar",
				...
				&v2.DurationFlag{
					...
					Usage:    "set the value of the operation's \"ExampleDuration\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "example-empty",
					Usage:    "set the value of the operation's \"ExampleEmpty\" parameter",
					Category: "INPUT",
				},
				&v2.TimestampFlag{
					Name:     "example-timestamp",
					Usage:    "set the value of the operation's \"ExampleTimestamp\" parameter",
					Category: "INPUT",
					Layout:   time.RFC3339Nano,
				},
				&v2.StringFlag{
					Name:     "example-enum",
					Usage:    "set the value of the operation's \"ExampleEnum\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "common-enum",
					Usage:    "set the value of the operation's \"CommonEnum\" parameter",
					Category: "INPUT",
				},
			},
			Action: func(cmd *v2.Context) error {
...
func UnmarshalCliFlagsToOtherUpdateRequest(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*OtherUpdateRequest, error) {
	...
	if cmd.IsSet("mode") {
		hasValues = true
		value := cmd.String(opts.FlagName("mode"))
		result.Mode = value
	}
	if !hasValues {
		return nil, nil
...
func UnmarshalCliFlagsToOtherWorkflowRequest(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*OtherWorkflowRequest, error) {
	...
	if cmd.IsSet("some-val") {
		hasValues = true
		value := cmd.String(opts.FlagName("some-val"))
		result.SomeVal = value
	}
	if cmd.IsSet("baz") {
		hasValues = true
		var tmp OtherWorkflowRequest_Baz
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("baz"))), &tmp); err != nil {
	...
	if cmd.IsSet("qux") {
		hasValues = true
		var tmp Qux
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("qux"))), &tmp); err != nil {
	...
	if cmd.IsSet("foo") {
		hasValues = true
		var tmp Foo
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("foo"))), &tmp); err != nil {
	...
	if cmd.IsSet("bar") {
		...
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("bar"))), &tmp); err != nil {
	...
	if cmd.IsSet("example-bytes") {
		hasValues = true
		value, err := base64.StdEncoding.DecodeString(cmd.String(opts.FlagName("example-bytes")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-double") {
		hasValues = true
		value := cmd.Float64(opts.FlagName("example-double"))
		oneOfValue := &OtherWorkflowRequest_ExampleDouble{ExampleDouble: value}
		result.ExampleOneof = oneOfValue
	}
	if cmd.IsSet("example-float") {
		hasValues = true
		value, err := convert.SafeCast[float64, float32](cmd.Float64(opts.FlagName("example-float")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-int-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("example-int-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-int-64") {
		hasValues = true
		value := cmd.Int64(opts.FlagName("example-int-64"))
		oneOfValue := &OtherWorkflowRequest_ExampleInt64{ExampleInt64: value}
		result.ExampleOneof = oneOfValue
	}
	if cmd.IsSet("example-uint-32") {
		hasValues = true
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(opts.FlagName("example-uint-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-uint-64") {
		hasValues = true
		value := cmd.Uint64(opts.FlagName("example-uint-64"))
		oneOfValue := &OtherWorkflowRequest_ExampleUint64{ExampleUint64: value}
		result.ExampleOneof = oneOfValue
	}
	if cmd.IsSet("example-sint-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("example-sint-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-sint-64") {
		hasValues = true
		value := cmd.Int64(opts.FlagName("example-sint-64"))
		oneOfValue := &OtherWorkflowRequest_ExampleSint64{ExampleSint64: value}
		result.ExampleOneof = oneOfValue
	}
	if cmd.IsSet("example-fixed-32") {
		hasValues = true
		value, err := convert.SafeCast[uint64, uint32](cmd.Uint64(opts.FlagName("example-fixed-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-fixed-64") {
		hasValues = true
		value := cmd.Uint64(opts.FlagName("example-fixed-64"))
		oneOfValue := &OtherWorkflowRequest_ExampleFixed64{ExampleFixed64: value}
		result.ExampleOneof = oneOfValue
	}
	if cmd.IsSet("example-sfixed-32") {
		hasValues = true
		value, err := convert.SafeCast[int64, int32](cmd.Int64(opts.FlagName("example-sfixed-32")))
		if err != nil {
			return nil, err
		}
	...
	if cmd.IsSet("example-enum") {
		hasValues = true
		enumID, ok := OtherEnum_value[cmd.String(opts.FlagName("example-enum"))]
		if !ok {
	...
	if cmd.IsSet("common-enum") {
		hasValues = true
		enumID, ok := v1.Example_value[cmd.String(opts.FlagName("common-enum"))]
		if !ok {
			return nil, fmt.Errorf("invalid value for enum field %s", "ExampleOneof")
		}
