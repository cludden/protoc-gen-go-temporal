...
// versions:
//
//	protoc-gen-go_temporal 1.12.1-next (4575e9e51085e085491c95bb636e80617a121bc8)
//	go go1.22.2
//	protoc (unknown)
//
...
func (a *simpleActivities) SomeWorkflow1(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.SomeWorkflow1Response, err error) {
	...
	for {
		...
		case <-ctx.Done():
			...
			return nil, simpleOptions.convertError(workflow.ErrCanceled)
		case <-doneCh:
...
func (a *simpleActivities) SomeWorkflow2(ctx context.Context, input *v11.WorkflowRequest) (err error) {
	// initialize workflow execution
	...
	for {
		...
		case <-ctx.Done():
			...
			return simpleOptions.convertError(workflow.ErrCanceled)
		case <-doneCh:
			return simpleOptions.convertError(err)
		}
	}
...
func (a *simpleActivities) SomeWorkflow2WithSomeSignal1(ctx context.Context, input *v11.WorkflowRequest) (err error) {
	// initialize workflow execution
	var run v1.SomeWorkflow2Run
...
//
// Deprecated: Do not use.
func (a *simpleActivities) SomeWorkflow3(ctx context.Context, input *v11.WorkflowRequest) (err error) {
...
//
// Deprecated: Do not use.
func (a *simpleActivities) SomeWorkflow3WithSomeSignal2(ctx context.Context, input *v11.WorkflowRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeWorkflow3WorkflowName)
...
func (a *simpleActivities) SomeQuery1(ctx context.Context, input *v11.QueryRequest) (resp *v1.SomeQuery1Response, err error) {
...
func (a *simpleActivities) SomeQuery2(ctx context.Context, input *v11.QueryRequest) (resp *v1.SomeQuery2Response, err error) {
...
func (a *simpleActivities) SomeSignal1(ctx context.Context, input *v11.SignalRequest) (err error) {
	// execute signal in child goroutine
	doneCh := make(chan struct{})
	go func() {
...
func (a *simpleActivities) SomeSignal2(ctx context.Context, input *v11.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *simpleActivities) SomeSignal3(ctx context.Context, input *v11.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *simpleActivities) SomeUpdate1(ctx context.Context, input *v11.UpdateRequest) (resp *v1.SomeUpdate1Response, err error) {
...
func (a *otherActivities) OtherWorkflow(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.OtherWorkflowResponse, err error) {
	// unmarshal workflow request
	...
	for {
		...
		case <-ctx.Done():
			...
			return nil, otherOptions.convertError(workflow.ErrCanceled)
		case <-doneCh:
...
func (a *otherActivities) OtherQuery(ctx context.Context, input *v11.QueryRequest) (resp *v1.OtherQueryResponse, err error) {
	// execute signal in child goroutine
	doneCh := make(chan struct{})
	go func() {
...
func (a *otherActivities) OtherSignal(ctx context.Context, input *v11.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *otherActivities) OtherUpdate(ctx context.Context, input *v11.UpdateRequest) (resp *v1.OtherUpdateResponse, err error) {
...
func (a *ignoredActivities) What(ctx context.Context, input *v11.WorkflowRequest) (err error) {
	// unmarshal workflow request
	...
	for {
		...
		case <-ctx.Done():
			...
			return ignoredOptions.convertError(workflow.ErrCanceled)
		case <-doneCh:
			return ignoredOptions.convertError(err)
		}
	}
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	...
	for {
		...
		case <-ctx.Done():
			...
			return nil, deprecatedOptions.convertError(workflow.ErrCanceled)
		case <-doneCh:
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeDeprecatedWorkflow1WorkflowName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2(ctx context.Context, input *v11.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeDeprecatedWorkflow2WorkflowName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedQuery1(ctx context.Context, input *v11.QueryRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedQuery2(ctx context.Context, input *v11.QueryRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedSignal1(ctx context.Context, input *v11.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", v1.SomeDeprecatedSignal1SignalName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedSignal2(ctx context.Context, input *v11.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", v1.SomeDeprecatedSignal2SignalName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedUpdate1(ctx context.Context, input *v11.UpdateRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedUpdate2(ctx context.Context, input *v11.UpdateRequest) (resp *v1.SomeDeprecatedMessage, err error) {
