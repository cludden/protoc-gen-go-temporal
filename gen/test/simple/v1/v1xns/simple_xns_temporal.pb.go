...
// versions:
//
//	protoc-gen-go_temporal 1.13.1-next (78b68eb6b9efd4c63dd41c64f379728647a12c1e)
//	go go1.22.3
//	protoc (unknown)
//
...
import (
	...
	v14 "go.temporal.io/api/update/v1"
...
func (opts *SomeWorkflow1WorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SomeWorkflow1WorkflowOptions {
...
func SomeWorkflow1Async(ctx workflow.Context, req *v1.SomeWorkflow1Request, opts ...*SomeWorkflow1WorkflowOptions) (SomeWorkflow1Run, error) {
	...
	if wo.ID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.SomeWorkflow1Idexpression, req.ProtoReflect())
			if err != nil {
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *SomeWorkflow2WorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SomeWorkflow2WorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *SomeWorkflow3WorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SomeWorkflow3WorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
func SomeWorkflow3Async(ctx workflow.Context, req *v1.SomeWorkflow3Request, opts ...*SomeWorkflow3WorkflowOptions) (SomeWorkflow3Run, error) {
	...
	if wo.ID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.SomeWorkflow3Idexpression, req.ProtoReflect())
			if err != nil {
...
func SomeUpdate1Async(ctx workflow.Context, workflowID string, runID string, req *v1.SomeUpdate1Request, opts ...*SomeUpdate1UpdateOptions) (SomeUpdate1Handle, error) {
	...
	if uo.UpdateID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.SomeUpdate1Idexpression, req.ProtoReflect())
			if err != nil {
	...
	return &someUpdate1Handle{
		cancel: cancel,
		id:     uo.UpdateID,
		future: workflow.ExecuteActivity(ctx, activityName, &v13.UpdateRequest{
			HeartbeatInterval:     durationpb.New(opt.HeartbeatInterval),
			Request:               wreq,
...
func (a *simpleActivities) SomeWorkflow1(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.SomeWorkflow1Response, err error) {
	...
	run, err = a.client.SomeWorkflow1Async(ctx, &req, v1.NewSomeWorkflow1Options().WithStartWorkflowOptions(
...
func (a *simpleActivities) SomeWorkflow2(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// initialize workflow execution
	var run v1.SomeWorkflow2Run
	run, err = a.client.SomeWorkflow2Async(ctx, v1.NewSomeWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
...
func (a *simpleActivities) SomeWorkflow2WithSomeSignal1(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// initialize workflow execution
	var run v1.SomeWorkflow2Run
	run, err = a.client.SomeWorkflow2WithSomeSignal1Async(ctx, v1.NewSomeWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return simpleOptions.convertError(err)
...
//
// Deprecated: Do not use.
func (a *simpleActivities) SomeWorkflow3(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	...
	run, err = a.client.SomeWorkflow3Async(ctx, &req, v1.NewSomeWorkflow3Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return simpleOptions.convertError(err)
...
//
// Deprecated: Do not use.
func (a *simpleActivities) SomeWorkflow3WithSomeSignal2(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeWorkflow3WorkflowName)
	...
	// initialize workflow execution
	var run v1.SomeWorkflow3Run
	run, err = a.client.SomeWorkflow3WithSomeSignal2Async(ctx, &req, &signal, v1.NewSomeWorkflow3Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return simpleOptions.convertError(err)
...
func (a *simpleActivities) SomeQuery1(ctx context.Context, input *v13.QueryRequest) (resp *v1.SomeQuery1Response, err error) {
...
func (a *simpleActivities) SomeQuery2(ctx context.Context, input *v13.QueryRequest) (resp *v1.SomeQuery2Response, err error) {
...
func (a *simpleActivities) SomeSignal1(ctx context.Context, input *v13.SignalRequest) (err error) {
	// execute signal in child goroutine
	doneCh := make(chan struct{})
	go func() {
...
func (a *simpleActivities) SomeSignal2(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *simpleActivities) SomeSignal3(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *simpleActivities) SomeUpdate1(ctx context.Context, input *v13.UpdateRequest) (resp *v1.SomeUpdate1Response, err error) {
	...
	if activity.HasHeartbeatDetails(ctx) {
		...
		uo.WaitPolicy = &v14.WaitPolicy{
			LifecycleStage: v11.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_ACCEPTED,
		}
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *OtherWorkflowWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *OtherWorkflowWorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
func OtherWorkflowAsync(ctx workflow.Context, req *v1.OtherWorkflowRequest, opts ...*OtherWorkflowWorkflowOptions) (OtherWorkflowRun, error) {
	...
	if wo.ID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.OtherWorkflowIdexpression, req.ProtoReflect())
			if err != nil {
...
func OtherUpdateAsync(ctx workflow.Context, workflowID string, runID string, req *v1.OtherUpdateRequest, opts ...*OtherUpdateUpdateOptions) (OtherUpdateHandle, error) {
	...
	if uo.UpdateID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.OtherUpdateIdexpression, req.ProtoReflect())
			if err != nil {
...
func (a *otherActivities) OtherWorkflow(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.OtherWorkflowResponse, err error) {
	// unmarshal workflow request
	...
	run, err = a.client.OtherWorkflowAsync(ctx, &req, v1.NewOtherWorkflowOptions().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
...
func (a *otherActivities) OtherQuery(ctx context.Context, input *v13.QueryRequest) (resp *v1.OtherQueryResponse, err error) {
	// execute signal in child goroutine
	doneCh := make(chan struct{})
	go func() {
...
func (a *otherActivities) OtherSignal(ctx context.Context, input *v13.SignalRequest) (err error) {
	// unmarshal signal request
...
func (a *otherActivities) OtherUpdate(ctx context.Context, input *v13.UpdateRequest) (resp *v1.OtherUpdateResponse, err error) {
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *WhatWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *WhatWorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
func WhatAsync(ctx workflow.Context, req *v1.WhatRequest, opts ...*WhatWorkflowOptions) (WhatRun, error) {
	...
	if wo.ID == "" {
		if err := workflow.SideEffect(ctx, func(ctx workflow.Context) any {
			id, err := expression.EvalExpression(v1.WhatIdexpression, req.ProtoReflect())
			if err != nil {
...
func (a *ignoredActivities) What(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// unmarshal workflow request
	...
	// initialize workflow execution
	var run v1.WhatRun
	run, err = a.client.WhatAsync(ctx, &req, v1.NewWhatOptions().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
...
// convertError is applied to all xns activity errors
func (opts *OnlyActivitiesOptions) convertError(err error) error {
	if err == nil {
		return nil
	}
	if opts != nil && opts.errorConverter != nil {
...
// filterActivity is used to filter xns activity registrations
func (opts *OnlyActivitiesOptions) filterActivity(name string) string {
	if opts == nil || opts.filter == nil {
		return name
	}
	return opts.filter(name)
...
func RegisterOnlyActivitiesActivities(r worker.ActivityRegistry, c v1.OnlyActivitiesClient, options ...*OnlyActivitiesOptions) {
	if onlyActivitiesOptions == nil && len(options) > 0 && options[0] != nil {
		onlyActivitiesOptions = options[0]
	}
	a := &onlyActivitiesActivities{c}
	if name := onlyActivitiesOptions.filterActivity("mycompany.simple.OnlyActivities.CancelWorkflow"); name != "" {
		r.RegisterActivityWithOptions(a.CancelWorkflow, activity.RegisterOptions{Name: name})
	}
}
...
func CancelOnlyActivitiesWorkflowAsync(ctx workflow.Context, workflowID string, runID string) workflow.Future {
	activityName := onlyActivitiesOptions.filterActivity("mycompany.simple.OnlyActivities.CancelWorkflow")
	if activityName == "" {
		f, s := workflow.NewFuture(ctx)
		s.SetError(temporal.NewNonRetryableApplicationError(
...
type onlyActivitiesActivities struct {
	client v1.OnlyActivitiesClient
}
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *SomeDeprecatedWorkflow1WorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SomeDeprecatedWorkflow1WorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
// WithParentClosePolicy can be used to customize the cancellation propagation behavior
func (opts *SomeDeprecatedWorkflow2WorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *SomeDeprecatedWorkflow2WorkflowOptions {
	opts.ParentClosePolicy = policy
	return opts
}
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	...
	run, err = a.client.SomeDeprecatedWorkflow1Async(ctx, &req, v1.NewSomeDeprecatedWorkflow1Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeDeprecatedWorkflow1WorkflowName)
	...
	// initialize workflow execution
	var run v1.SomeDeprecatedWorkflow1Run
	run, err = a.client.SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1Async(ctx, &req, &signal, v1.NewSomeDeprecatedWorkflow1Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, deprecatedOptions.convertError(err)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	...
	run, err = a.client.SomeDeprecatedWorkflow2Async(ctx, &req, v1.NewSomeDeprecatedWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, deprecatedOptions.convertError(err)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2(ctx context.Context, input *v13.WorkflowRequest) (resp *v1.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", v1.SomeDeprecatedWorkflow2WorkflowName)
	...
	// initialize workflow execution
	var run v1.SomeDeprecatedWorkflow2Run
	run, err = a.client.SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2Async(ctx, &req, &signal, v1.NewSomeDeprecatedWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, deprecatedOptions.convertError(err)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedQuery1(ctx context.Context, input *v13.QueryRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedQuery2(ctx context.Context, input *v13.QueryRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedSignal1(ctx context.Context, input *v13.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", v1.SomeDeprecatedSignal1SignalName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedSignal2(ctx context.Context, input *v13.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", v1.SomeDeprecatedSignal2SignalName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedUpdate1(ctx context.Context, input *v13.UpdateRequest) (resp *v1.SomeDeprecatedMessage, err error) {
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedUpdate2(ctx context.Context, input *v13.UpdateRequest) (resp *v1.SomeDeprecatedMessage, err error) {
