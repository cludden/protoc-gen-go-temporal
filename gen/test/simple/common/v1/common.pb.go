...
func file_test_simple_common_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_test_simple_common_v1_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_test_simple_common_v1_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
