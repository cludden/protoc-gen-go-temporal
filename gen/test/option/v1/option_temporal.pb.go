...
func (c *testClient) UpdateWithInput(ctx context.Context, workflowID string, runID string, req *UpdateWithInputRequest, opts ...*UpdateWithInputOptions) error {
	...
	handle, err := c.UpdateWithInputAsync(ctx, workflowID, runID, req, o.WithWaitPolicy(v1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return err
	}
...
func (o *WorkflowWithInputOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *WorkflowWithInputOptions {
...
func NewUpdateWithInputOptions() *UpdateWithInputOptions {
	return &UpdateWithInputOptions{Options: &client.UpdateWorkflowWithOptionsRequest{}}
}

// Build initializes a new client.UpdateWorkflowWithOptionsRequest with defaults and overrides applied
func (o *UpdateWithInputOptions) Build(workflowID string, runID string, req *UpdateWithInputRequest) (opts *client.UpdateWorkflowWithOptionsRequest, err error) {
...
func (o *UpdateWithInputOptions) WithUpdateWorkflowOptions(options client.UpdateWorkflowWithOptionsRequest) *UpdateWithInputOptions {
	o.Options = &options
	return o
}

// WithWaitPolicy sets the WaitPolicy
func (o *UpdateWithInputOptions) WithWaitPolicy(policy v1.UpdateWorkflowExecutionLifecycleStage) *UpdateWithInputOptions {
	o.waitPolicy = policy
	return o
}
...
func (o *WorkflowWithInputChildOptions) Build(ctx workflow.Context, req protoreflect.Message) (workflow.ChildWorkflowOptions, error) {
	...
	} else if opts.ParentClosePolicy == v1.PARENT_CLOSE_POLICY_UNSPECIFIED {
		opts.ParentClosePolicy = v1.PARENT_CLOSE_POLICY_REQUEST_CANCEL
	}
...
// WithIDReusePolicy sets the WorkflowIDReusePolicy value
func (o *WorkflowWithInputChildOptions) WithIDReusePolicy(policy v1.WorkflowIdReusePolicy) *WorkflowWithInputChildOptions {
	o.idReusePolicy = policy
	return o
}

// WithParentClosePolicy sets the WorkflowIDReusePolicy value
func (o *WorkflowWithInputChildOptions) WithParentClosePolicy(policy v1.ParentClosePolicy) *WorkflowWithInputChildOptions {
