...
func (c *testClient) UpdateWithInput(ctx context.Context, workflowID string, runID string, req *UpdateWithInputRequest, opts ...*UpdateWithInputOptions) error {
	...
	handle, err := c.UpdateWithInputAsync(ctx, workflowID, runID, req, o.WithWaitPolicy(enumsv1.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_COMPLETED))
	if err != nil {
		return err
	}
...
func (o *UpdateWithInputOptions) WithWaitPolicy(policy enumsv1.UpdateWorkflowExecutionLifecycleStage) *UpdateWithInputOptions {
	o.waitPolicy = policy
	return o
}
