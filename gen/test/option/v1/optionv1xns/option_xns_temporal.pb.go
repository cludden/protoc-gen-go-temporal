...
// WorkflowWithInputAsync executes a(n) test.option.v1.Test.WorkflowWithInput workflow and blocks until error or response received
...
func (a *testActivities) WorkflowWithInput(ctx context.Context, input *v11.WorkflowRequest) (err error) {
...
func (a *testActivities) UpdateWithInput(ctx context.Context, input *v11.UpdateRequest) (err error) {
