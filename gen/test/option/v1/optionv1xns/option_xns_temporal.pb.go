...
func (opts *WorkflowWithInputWorkflowOptions) WithParentClosePolicy(policy v11.ParentClosePolicy) *WorkflowWithInputWorkflowOptions {
...
func (a *testActivities) WorkflowWithInput(ctx context.Context, input *v13.WorkflowRequest) (err error) {
...
func (a *testActivities) UpdateWithInput(ctx context.Context, input *v13.UpdateRequest) (err error) {
