...
func (o *PutOpaqueExampleOptions) WithTypedSearchAttributes(tsa temporal.SearchAttributes) *PutOpaqueExampleOptions {
	o.typedSearchAttributes = &tsa
	return o
}

// WithVersioningOverride sets the VersioningOverride value
func (o *PutOpaqueExampleOptions) WithVersioningOverride(versioningOverride client.VersioningOverride) *PutOpaqueExampleOptions {
...
func (i *PutOpaqueExampleWorkflowInput) ContinueAsNew(ctx workflow.Context, input *OpaqueExample, options ...workflow.ContinueAsNewErrorOptions) (*OpaqueExample, error) {
	next := i.Req
	if input != nil {
		next = input
	}
	if len(options) > 0 {
		return nil, workflow.NewContinueAsNewErrorWithOptions(ctx, options[0], PutOpaqueExampleWorkflowName, next)
	}
...
// WithTypedSearchAttributes sets the TypedSearchAttributes value
func (o *PutOpaqueExampleChildOptions) WithTypedSearchAttributes(tsa temporal.SearchAttributes) *PutOpaqueExampleChildOptions {
	o.typedSearchAttributes = &tsa
	return o
}
