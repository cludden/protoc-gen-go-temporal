...
const (
	SignalSignalName = "test.opaque.Optional.Signal"
)
...
type OptionalClient interface {
	...
	// PutOptionalExampleWithSignal sends a(n) test.opaque.Optional.Signal signal to a(n) test.opaque.Optional.PutOptionalExample workflow, starting it if necessary, and blocks until workflow completion
	PutOptionalExampleWithSignal(ctx context.Context, req *OptionalExample, signal *OptionalExample, opts ...*PutOptionalExampleOptions) (*OptionalExample, error)

	// PutOptionalExampleWithSignalAsync sends a(n) test.opaque.Optional.Signal signal to a(n) test.opaque.Optional.PutOptionalExample workflow, starting it if necessary, and returns a handle to the workflow execution
	PutOptionalExampleWithSignalAsync(ctx context.Context, req *OptionalExample, signal *OptionalExample, opts ...*PutOptionalExampleOptions) (PutOptionalExampleRun, error)
	...
	// test.opaque.Optional.Signal sends a(n) test.opaque.Optional.Signal signal
	Signal(ctx context.Context, workflowID string, runID string, signal *OptionalExample) error
}
...
// PutOptionalExampleWithSignal starts a(n) test.opaque.Optional.PutOptionalExample workflow and sends a(n) test.opaque.Optional.Signal signal in a transaction
func (c *optionalClient) PutOptionalExampleWithSignal(ctx context.Context, req *OptionalExample, signal *OptionalExample, options ...*PutOptionalExampleOptions) (*OptionalExample, error) {
	run, err := c.PutOptionalExampleWithSignalAsync(ctx, req, signal, options...)
	if err != nil {
		return nil, err
	}
	return run.Get(ctx)
...
// PutOptionalExampleWithSignalAsync starts a(n) test.opaque.Optional.PutOptionalExample workflow and sends a(n) test.opaque.Optional.Signal signal in a transaction
func (c *optionalClient) PutOptionalExampleWithSignalAsync(ctx context.Context, req *OptionalExample, signal *OptionalExample, options ...*PutOptionalExampleOptions) (PutOptionalExampleRun, error) {
	var o *PutOptionalExampleOptions
	if len(options) > 0 && options[0] != nil {
		o = options[0]
	} else {
	...
	run, err := c.client.SignalWithStartWorkflow(ctx, opts.ID, SignalSignalName, signal, opts, PutOptionalExampleWorkflowName, req)
	if run == nil || err != nil {
		return nil, err
	}
	return &putOptionalExampleRun{
...
// test.opaque.Optional.Signal sends a(n) test.opaque.Optional.Signal signal to an existing workflow
func (c *optionalClient) Signal(ctx context.Context, workflowID string, runID string, signal *OptionalExample) error {
	return c.client.SignalWorkflow(ctx, workflowID, runID, SignalSignalName, signal)
}
...
type PutOptionalExampleRun interface {
	...
	// test.opaque.Optional.Signal sends a(n) test.opaque.Optional.Signal signal
	Signal(ctx context.Context, req *OptionalExample) error
}
...
// test.opaque.Optional.Signal sends a(n) test.opaque.Optional.Signal signal
func (r *putOptionalExampleRun) Signal(ctx context.Context, req *OptionalExample) error {
	return r.client.Signal(ctx, r.ID(), "", req)
}
...
func buildPutOptionalExample(ctor func(workflow.Context, *PutOptionalExampleWorkflowInput) (PutOptionalExampleWorkflow, error)) func(workflow.Context, *OptionalExample) (*OptionalExample, error) {
	return func(ctx workflow.Context, req *OptionalExample) (*OptionalExample, error) {
		input := &PutOptionalExampleWorkflowInput{
			Req: req,
			Signal: &SignalSignal{
				Channel: workflow.GetSignalChannel(ctx, SignalSignalName),
			},
		}
...
// Signal sends a(n) "test.opaque.Optional.Signal" signal request to the child workflow
func (r *PutOptionalExampleChildRun) Signal(ctx workflow.Context, input *OptionalExample) error {
	return r.SignalAsync(ctx, input).Get(ctx, nil)
}

// SignalAsync sends a(n) "test.opaque.Optional.Signal" signal request to the child workflow
func (r *PutOptionalExampleChildRun) SignalAsync(ctx workflow.Context, input *OptionalExample) workflow.Future {
	return r.Future.SignalChildWorkflow(ctx, SignalSignalName, input)
}

// SignalSignal describes a(n) test.opaque.Optional.Signal signal
type SignalSignal struct {
	Channel workflow.ReceiveChannel
}

// NewSignalSignal initializes a new test.opaque.Optional.Signal signal wrapper
func NewSignalSignal(ctx workflow.Context) *SignalSignal {
	return &SignalSignal{Channel: workflow.GetSignalChannel(ctx, SignalSignalName)}
}

// Receive blocks until a(n) test.opaque.Optional.Signal signal is received
func (s *SignalSignal) Receive(ctx workflow.Context) (*OptionalExample, bool) {
	var resp OptionalExample
	more := s.Channel.Receive(ctx, &resp)
	return &resp, more
}

// ReceiveAsync checks for a test.opaque.Optional.Signal signal without blocking
func (s *SignalSignal) ReceiveAsync() *OptionalExample {
	var resp OptionalExample
...
// ReceiveWithTimeout blocks until a(n) test.opaque.Optional.Signal signal is received or timeout expires.
...
func (s *SignalSignal) ReceiveWithTimeout(ctx workflow.Context, timeout time.Duration) (resp *OptionalExample, ok bool, more bool) {
...
// Select checks for a(n) test.opaque.Optional.Signal signal without blocking
func (s *SignalSignal) Select(sel workflow.Selector, fn func(*OptionalExample)) workflow.Selector {
...
// SignalExternal sends a(n) test.opaque.Optional.Signal signal to an existing workflow
func SignalExternal(ctx workflow.Context, workflowID string, runID string, req *OptionalExample) error {
	return SignalExternalAsync(ctx, workflowID, runID, req).Get(ctx, nil)
}

// SignalExternalAsync sends a(n) test.opaque.Optional.Signal signal to an existing workflow
func SignalExternalAsync(ctx workflow.Context, workflowID string, runID string, req *OptionalExample) workflow.Future {
	return workflow.SignalExternalWorkflow(ctx, workflowID, runID, SignalSignalName, req)
}
...
// PutOptionalExampleWithSignal sends a(n) test.opaque.Optional.Signal signal to a(n) test.opaque.Optional.PutOptionalExample workflow, starting it if necessary
func (c *TestOptionalClient) PutOptionalExampleWithSignal(ctx context.Context, req *OptionalExample, signal *OptionalExample, opts ...*PutOptionalExampleOptions) (*OptionalExample, error) {
	c.env.RegisterDelayedCallback(func() {
		c.env.SignalWorkflow(SignalSignalName, signal)
	}, 0)
	return c.PutOptionalExample(ctx, req, opts...)
}

// PutOptionalExampleWithSignalAsync sends a(n) test.opaque.Optional.Signal signal to a(n) test.opaque.Optional.PutOptionalExample workflow, starting it if necessary
func (c *TestOptionalClient) PutOptionalExampleWithSignalAsync(ctx context.Context, req *OptionalExample, signal *OptionalExample, opts ...*PutOptionalExampleOptions) (PutOptionalExampleRun, error) {
	c.env.RegisterDelayedCallback(func() {
		c.env.SignalWorkflow(SignalSignalName, signal)
	}, 0)
...
// Signal executes a test.opaque.Optional.Signal signal
func (c *TestOptionalClient) Signal(ctx context.Context, workflowID string, runID string, req *OptionalExample) error {
	c.env.SignalWorkflow(SignalSignalName, req)
	return nil
}
...
// Signal executes a test.opaque.Optional.Signal signal against a test test.opaque.Optional.PutOptionalExample workflow
func (r *testPutOptionalExampleRun) Signal(ctx context.Context, req *OptionalExample) error {
	return r.client.Signal(ctx, r.ID(), r.RunID(), req)
}
...
func newOptionalCommands(options ...*OptionalCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		{
			Name:                   "signal",
			Usage:                  "executes a test.opaque.Optional.Signal signal",
			Category:               "SIGNALS",
			...
			Action: func(cmd *v2.Context) error {
				...
				req, err := UnmarshalCliFlagsToOptionalExample(cmd)
				if err != nil {
					return fmt.Errorf("error unmarshalling request: %w", err)
				}
				if err := client.Signal(cmd.Context, cmd.String("workflow-id"), cmd.String("run-id"), req); err != nil {
					return fmt.Errorf("error sending %q signal: %w", SignalSignalName, err)
				}
				fmt.Println("success")
				return nil
			},
		...
		// sends a test.opaque.Optional.Signal signal to a test.opaque.Optional.PutOptionalExample workflow, starting it if necessary,
		{
			Name:                   "put-optional-example-with-signal",
			Usage:                  "sends a test.opaque.Optional.Signal signal to a test.opaque.Optional.PutOptionalExample workflow, starting it if necessary",
			Category:               "WORKFLOWS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
			Flags: []v2.Flag{
				...
				&v2.Int64Flag{
					Name:     "signal-connection-id",
					Usage:    "set the value of the operation's \"ConnectionId\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64SliceFlag{
					Name:     "signal-connection-ids",
					Usage:    "set the value of the operation's \"ConnectionIds\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-session-id",
					Usage:    "set the value of the operation's \"SessionId\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64SliceFlag{
					Name:     "signal-session-ids",
					Usage:    "set the value of the operation's \"SessionIds\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-fixed-size",
					Usage:    "set the value of the operation's \"FixedSize\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64SliceFlag{
					Name:     "signal-fixed-sizes",
					Usage:    "set the value of the operation's \"FixedSizes\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-fixed-length",
					Usage:    "set the value of the operation's \"FixedLength\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64SliceFlag{
					Name:     "signal-fixed-lengths",
					Usage:    "set the value of the operation's \"FixedLengths\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-sfixed-size",
					Usage:    "set the value of the operation's \"SfixedSize\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64SliceFlag{
					Name:     "signal-sfixed-sizes",
					Usage:    "set the value of the operation's \"SfixedSizes\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-sfixed-length",
					Usage:    "set the value of the operation's \"SfixedLength\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64SliceFlag{
					Name:     "signal-sfixed-lengths",
					Usage:    "set the value of the operation's \"SfixedLengths\" parameter",
					Category: "SIGNAL",
				},
				&v2.BoolFlag{
					Name:     "signal-is-active",
					Usage:    "set the value of the operation's \"IsActive\" parameter",
					Category: "SIGNAL",
				},
				&v2.StringSliceFlag{
					Name:     "signal-is-actives",
					Usage:    "set the value of the operation's \"IsActives\" parameter",
					Category: "SIGNAL",
				},
				&v2.StringFlag{
				...
				&v2.StringSliceFlag{
					Name:     "signal-previous-addresses",
					Usage:    "set the value of the operation's \"PreviousAddresses\" parameter",
					Category: "SIGNAL",
				},
				&v2.StringFlag{
					Name:     "signal-oneof-name",
					Usage:    "set the value of the operation's \"OneofName\" parameter",
					Category: "SIGNAL",
				},
				&v2.Float64Flag{
					Name:     "signal-oneof-score",
					Usage:    "set the value of the operation's \"OneofScore\" parameter",
					Category: "SIGNAL",
				},
				&v2.Float64Flag{
					Name:     "signal-oneof-ratio",
					Usage:    "set the value of the operation's \"OneofRatio\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-age",
					Usage:    "set the value of the operation's \"OneofAge\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-id",
					Usage:    "set the value of the operation's \"OneofId\" parameter",
					Category: "SIGNAL",
				},
				&v2.StringFlag{
					Name:     "signal-oneof-status",
					Usage:    "set the value of the operation's \"OneofStatus\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-oneof-size",
					Usage:    "set the value of the operation's \"OneofSize\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-oneof-length",
					Usage:    "set the value of the operation's \"OneofLength\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-connection-id",
					Usage:    "set the value of the operation's \"OneofConnectionId\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-session-id",
					Usage:    "set the value of the operation's \"OneofSessionId\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-oneof-fixed-size",
					Usage:    "set the value of the operation's \"OneofFixedSize\" parameter",
					Category: "SIGNAL",
				},
				&v2.Uint64Flag{
					Name:     "signal-oneof-fixed-length",
					Usage:    "set the value of the operation's \"OneofFixedLength\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-sfixed-size",
					Usage:    "set the value of the operation's \"OneofSfixedSize\" parameter",
					Category: "SIGNAL",
				},
				&v2.Int64Flag{
					Name:     "signal-oneof-sfixed-length",
					Usage:    "set the value of the operation's \"OneofSfixedLength\" parameter",
					Category: "SIGNAL",
				},
				&v2.BoolFlag{
					Name:     "signal-oneof-is-active",
					Usage:    "set the value of the operation's \"OneofIsActive\" parameter",
					Category: "SIGNAL",
				},
				&v2.StringFlag{
					Name:     "signal-oneof-data",
					Usage:    "set the value of the operation's \"OneofData\" parameter (base64-encoded)",
					Category: "SIGNAL",
				},
				&v2.StringFlag{
					Name:     "signal-oneof-address",
					Usage:    "set the value of the operation's \"OneofAddress\" parameter",
					Category: "SIGNAL",
				},
			},
			Action: func(cmd *v2.Context) error {
				...
				signal, err := UnmarshalCliFlagsToOptionalExample(cmd, helpers.UnmarshalCliFlagsOptions{
					Prefix: "signal",
				...
				run, err := client.PutOptionalExampleWithSignalAsync(cmd.Context, req, signal)
				if err != nil {
					return fmt.Errorf("error starting %s workflow with %s signal: %w", PutOptionalExampleWorkflowName, SignalSignalName, err)
				}
				if cmd.Bool("detach") {
					fmt.Println("success")
					fmt.Printf("workflow id: %s\n", run.ID())
