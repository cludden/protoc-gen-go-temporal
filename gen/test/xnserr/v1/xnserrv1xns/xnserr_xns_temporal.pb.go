...
func (a *serverActivities) Sleep(ctx context.Context, input *v13.WorkflowRequest) (err error) {
...
func (a *clientActivities) CallSleep(ctx context.Context, input *v13.WorkflowRequest) (err error) {
	// unmarshal workflow request
