...
func file_test_xnserr_v1_xnserr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_test_xnserr_v1_xnserr_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_test_xnserr_v1_xnserr_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_test_xnserr_v1_xnserr_proto_msgTypes[2].Exporter = func(v any, i int) any {
