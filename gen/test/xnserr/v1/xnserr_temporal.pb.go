	...
	commands := []*v2.Command{
		{
			...
			Flags: []v2.Flag{
				...
				&v2.DurationFlag{
					Name:     "sleep",
					Usage:    "set the value of the operation's \"Sleep\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "failure",
					Usage:    "set the value of the operation's \"Failure\" parameter",
					Category: "INPUT",
				},
			},
...
func UnmarshalCliFlagsToSleepRequest(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*SleepRequest, error) {
	...
	if cmd.IsSet("sleep") {
		hasValues = true
		value := durationpb.New(cmd.Duration(opts.FlagName("sleep")))
		result.Sleep = value
	}
	if cmd.IsSet("failure") {
		hasValues = true
		var tmp Failure
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("failure"))), &tmp); err != nil {
	...
	commands := []*v2.Command{
		{
			...
			Flags: []v2.Flag{
				...
				&v2.StringFlag{
					...
					Usage:    "set the value of the operation's \"StartWorkflowOptions\" parameter",
					Category: "INPUT",
				},
				&v2.StringFlag{
					Name:     "retry-policy",
					Usage:    "set the value of the operation's \"RetryPolicy\" parameter",
					Category: "INPUT",
				},
			},
			Action: func(cmd *v2.Context) error {
...
func UnmarshalCliFlagsToCallSleepRequest(cmd *v2.Context, options ...helpers.UnmarshalCliFlagsOptions) (*CallSleepRequest, error) {
	...
	if cmd.IsSet("start-workflow-options") {
		...
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("start-workflow-options"))), &tmp); err != nil {
	...
	if cmd.IsSet("retry-policy") {
		...
		if err := protojson.Unmarshal([]byte(cmd.String(opts.FlagName("retry-policy"))), &tmp); err != nil {
