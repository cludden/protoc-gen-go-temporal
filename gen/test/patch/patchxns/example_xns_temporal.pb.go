...
// FooServiceClientProviderInput describes a(n) test.patch.FooService xns activity invocation and is provided to a FooServiceClientProvider so that a
...
type FooServiceClientProviderInput struct {
	...
	// e.g. "test.patch.FooService.CancelWorkflow"
	ActivityName string
...
type FooServiceClientProvider func(ctx context.Context, in *FooServiceClientProviderInput) (patch.FooServiceClient, error)
...
// RegisterFooServiceActivities registers test.patch.FooService cross-namespace activities using a static client. When a
...
func RegisterFooServiceActivities(r worker.ActivityRegistry, c patch.FooServiceClient, options ...*FooServiceOptions) {
	...
	provider := FooServiceClientProvider(func(ctx context.Context, _ *FooServiceClientProviderInput) (patch.FooServiceClient, error) {
		return c, nil
	})
...
// RegisterFooServiceActivitiesWithClientProvider registers test.patch.FooService cross-namespace activities, using the given FooServiceClientProvider to
...
func (a *fooServiceActivities) CancelWorkflow(ctx context.Context, workflowID string, runID string) error {
	c, err := a.getClient(ctx, &FooServiceClientProviderInput{
		ActivityName: "test.patch.FooService.CancelWorkflow",
		RunID:        runID,
		WorkflowID:   workflowID,
	})
	if err != nil {
...
func (a *fooServiceActivities) GetFoo(ctx context.Context, input *xnsv1.GetWorkflowRequest) (out *patch.FooOutput, err error) {
	...
	c, err := a.getClient(ctx, &FooServiceClientProviderInput{
		ActivityName: "test.patch.FooService.GetFoo",
...
func (a *fooServiceActivities) Foo(ctx context.Context, input *xnsv1.WorkflowRequest) (resp *patch.FooOutput, err error) {
	...
	c, err := a.getClient(ctx, &FooServiceClientProviderInput{
		ActivityName: "test.patch.FooService.Foo",
	...
	run, err = c.FooAsync(actx, &req, patch.NewFooOptions().WithStartWorkflowOptions(
