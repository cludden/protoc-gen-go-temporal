...
var file_test_patch_example_proto_rawDesc = []byte{
...
var (
	...
	file_test_patch_example_proto_rawDescData = file_test_patch_example_proto_rawDesc
)

func file_test_patch_example_proto_rawDescGZIP() []byte {
	file_test_patch_example_proto_rawDescOnce.Do(func() {
		file_test_patch_example_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_patch_example_proto_rawDescData)
	})
...
func file_test_patch_example_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_test_patch_example_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_test_patch_example_proto_rawDesc = nil
