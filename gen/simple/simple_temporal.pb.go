...
// versions:
//
//	protoc-gen-go_temporal 0.7.6-next (9b4b84b8711127213e92a19898835252016506fd)
//	go go1.20.4
//	protoc (unknown)
//
...
type SomeWorkflow2Workflow interface {
	...
	ValidateSomeUpdate1(context.Context, *SomeUpdate1Request) error
	// SomeUpdate1 updates a SomeWorkflow2
	SomeUpdate1(context.Context, *SomeUpdate1Request) (*SomeUpdate1Response, error)
}
