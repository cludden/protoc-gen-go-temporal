...
func (h *someUpdate1Handle) Get(ctx context.Context) (*SomeUpdate1Response, error) {
	...
	go func() {
		for {
			if err = h.handle.Get(gctx, &resp); err != nil && strings.Contains(err.Error(), context.DeadlineExceeded.Error()) {
				continue
			}
			break
		}
...
// SomeWorkflow1 executes a(n) mycompany.simple.Simple.SomeWorkflow1 workflow in the test environment
...
// SomeWorkflow1Async executes a(n) mycompany.simple.Simple.SomeWorkflow1 workflow in the test environment
...
// SomeWorkflow2 executes a(n) mycompany.simple.Simple.SomeWorkflow2 workflow in the test environment
...
// SomeWorkflow2Async executes a(n) mycompany.simple.Simple.SomeWorkflow2 workflow in the test environment
...
// SomeWorkflow2WithSomeSignal1 sends a(n) mycompany.simple.Simple.SomeSignal1 signal to a(n) mycompany.simple.Simple.SomeWorkflow2 workflow, starting it if necessary
...
// SomeWorkflow2WithSomeSignal1Async sends a(n) mycompany.simple.Simple.SomeSignal1 signal to a(n) mycompany.simple.Simple.SomeWorkflow2 workflow, starting it if necessary
...
// testSomeWorkflow1Run provides convenience methods for interacting with a(n) mycompany.simple.Simple.SomeWorkflow1 workflow in the test environment
...
// Get retrieves a test mycompany.simple.Simple.SomeWorkflow1 workflow result
...
// ID returns a test mycompany.simple.Simple.SomeWorkflow1 workflow run's workflow ID
...
// SomeQuery1 executes a mycompany.simple.Simple.SomeQuery1 query against a test mycompany.simple.Simple.SomeWorkflow1 workflow
...
// SomeQuery2 executes a mycompany.simple.Simple.SomeQuery2 query against a test mycompany.simple.Simple.SomeWorkflow1 workflow
...
// SomeSignal1 executes a mycompany.simple.Simple.SomeSignal1 signal against a test mycompany.simple.Simple.SomeWorkflow1 workflow
func (r *testSomeWorkflow1Run) SomeSignal1(ctx context.Context) error {
	return r.client.SomeSignal1(ctx, r.ID(), r.RunID())
}

// SomeSignal2 executes a mycompany.simple.Simple.SomeSignal2 signal against a test mycompany.simple.Simple.SomeWorkflow1 workflow
...
// testSomeWorkflow2Run provides convenience methods for interacting with a(n) mycompany.simple.Simple.SomeWorkflow2 workflow in the test environment
...
// Get retrieves a test mycompany.simple.Simple.SomeWorkflow2 workflow result
...
// ID returns a test mycompany.simple.Simple.SomeWorkflow2 workflow run's workflow ID
...
// SomeSignal1 executes a mycompany.simple.Simple.SomeSignal1 signal against a test mycompany.simple.Simple.SomeWorkflow2 workflow
...
type OtherClient interface {
	...
	// mycompany.simple.Other.OtherUpdate executes a(n) mycompany.simple.Other.OtherUpdate update and blocks until update completion
...
type DeprecatedClient interface {
	...
	// SomeDeprecatedWorkflow1Async executes a(n) mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow asynchronously
	...
	// SomeDeprecatedWorkflow2Async executes a(n) mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow asynchronously
	...
	*/
	...
	// SomeDeprecatedUpdate1 retrieves a handle to an existing mycompany.simple.Deprecated.SomeDeprecatedUpdate1 update
	...
	*/
	...
	// SomeDeprecatedUpdate2 retrieves a handle to an existing mycompany.simple.Deprecated.SomeDeprecatedUpdate2 update
...
func NewDeprecatedClient(c client.Client) DeprecatedClient {
	return &deprecatedClient{client: c}
}

// NewDeprecatedClientWithOptions initializes a new Deprecated client with the given options
func NewDeprecatedClientWithOptions(c client.Client, opts client.Options) (DeprecatedClient, error) {
	var err error
	c, err = client.NewClientFromExisting(c, opts)
	if err != nil {
		return nil, fmt.Errorf("error initializing client with options: %w", err)
	}
	return &deprecatedClient{client: c}, nil
}

// SomeDeprecatedWorkflow1 executes a mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow and blocks until error or response received
...
// SomeDeprecatedWorkflow1Async starts a(n) mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow
...
// SomeDeprecatedWorkflow2 executes a mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow and blocks until error or response received
...
// SomeDeprecatedWorkflow2Async starts a(n) mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow
...
// SomeDeprecatedQuery1 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedQuery1 query to an existing workflow
...
// SomeDeprecatedQuery2 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedQuery2 query to an existing workflow
...
// SomeDeprecatedSignal1 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal1 signal to an existing workflow
...
// SomeDeprecatedSignal2 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal2 signal to an existing workflow
...
// SomeDeprecatedUpdate1 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate1 update to an existing workflow
...
// SomeDeprecatedUpdate1Async sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate1 update to an existing workflow
...
// SomeDeprecatedUpdate2 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate2 update to an existing workflow
...
// SomeDeprecatedUpdate2Async sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate2 update to an existing workflow
...
type SomeDeprecatedWorkflow1Run interface {
	...
	*/
	...
	// SomeDeprecatedUpdate1Async sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate1 update to the workflow
...
// SomeDeprecatedQuery1 executes a(n) mycompany.simple.Deprecated.SomeDeprecatedQuery1 query
...
// SomeDeprecatedSignal1 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal1 signal
...
// SomeDeprecatedUpdate1 executes a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate1 update
...
type SomeDeprecatedWorkflow2Run interface {
	...
	*/
	...
	// SomeDeprecatedUpdate2Async sends a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate2 update to the workflow
...
// SomeDeprecatedQuery2 executes a(n) mycompany.simple.Deprecated.SomeDeprecatedQuery2 query
...
// SomeDeprecatedSignal2 sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal2 signal
...
// SomeDeprecatedUpdate2 executes a(n) mycompany.simple.Deprecated.SomeDeprecatedUpdate2 update
...
// SomeDeprecatedWorkflow1Child executes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow
...
// SomeDeprecatedWorkflow1ChildAsync executes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow
...
// SomeDeprecatedWorkflow2Child executes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow
...
// SomeDeprecatedWorkflow2ChildAsync executes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow
...
// SomeDeprecatedSignal1External sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal1 signal to an existing workflow
...
// SomeDeprecatedSignal1ExternalAsync sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal1 signal to an existing workflow
...
// SomeDeprecatedSignal2External sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal2 signal to an existing workflow
...
// SomeDeprecatedSignal2ExternalAsync sends a(n) mycompany.simple.Deprecated.SomeDeprecatedSignal2 signal to an existing workflow
...
// SomeDeprecatedActivity1 does something (asynchronously)
...
// SomeDeprecatedActivity1 does something (locally)
...
// SomeDeprecatedActivity1 does something (asynchronously, locally)
...
// SomeDeprecatedActivity2 does something else Deprecated: a custom activity deprecation message.
...
// SomeDeprecatedActivity2 does something else Deprecated: a custom activity deprecation message. (asynchronously)
...
// SomeDeprecatedActivity2 does something else Deprecated: a custom activity deprecation message. (locally)
...
// SomeDeprecatedActivity2 does something else Deprecated: a custom activity deprecation message. (asynchronously, locally)
	...
	commands := []*v2.Command{
		...
		// SomeDeprecatedWorkflow1 does something,
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				run, err := client.SomeDeprecatedWorkflow1Async(cmd.Context, req)
				if err != nil {
		...
		// SomeDeprecatedWorkflow2 does something else Deprecated: a custom workflow deprecation message.,
		{
			...
			Action: func(cmd *v2.Context) error {
				...
				run, err := client.SomeDeprecatedWorkflow2Async(cmd.Context, req)
				if err != nil {
