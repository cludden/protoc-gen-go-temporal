...
func (c *simpleClient) SomeWorkflow1(ctx context.Context, req *SomeWorkflow1Request, options ...*client.StartWorkflowOptions) (*SomeWorkflow1Response, error) {
...
func (c *simpleClient) SomeWorkflow1Async(ctx context.Context, req *SomeWorkflow1Request, options ...*client.StartWorkflowOptions) (SomeWorkflow1Run, error) {
...
func (c *simpleClient) SomeWorkflow2(ctx context.Context, options ...*client.StartWorkflowOptions) error {
...
func (c *simpleClient) SomeWorkflow2Async(ctx context.Context, options ...*client.StartWorkflowOptions) (SomeWorkflow2Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *simpleClient) SomeWorkflow2WithSomeSignal1(ctx context.Context, options ...*client.StartWorkflowOptions) error {
...
func (c *simpleClient) SomeWorkflow2WithSomeSignal1Async(ctx context.Context, options ...*client.StartWorkflowOptions) (SomeWorkflow2Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *simpleClient) SomeWorkflow3(ctx context.Context, req *SomeWorkflow3Request, options ...*client.StartWorkflowOptions) error {
...
func (c *simpleClient) SomeWorkflow3Async(ctx context.Context, req *SomeWorkflow3Request, options ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *simpleClient) SomeWorkflow3WithSomeSignal2(ctx context.Context, req *SomeWorkflow3Request, signal *SomeSignal2Request, options ...*client.StartWorkflowOptions) error {
...
func (c *simpleClient) SomeWorkflow3WithSomeSignal2Async(ctx context.Context, req *SomeWorkflow3Request, signal *SomeSignal2Request, options ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *simpleClient) SomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (*SomeUpdate1Response, error) {
...
func (c *simpleClient) SomeUpdate1Async(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (SomeUpdate1Handle, error) {
	options := &client.UpdateWorkflowWithOptionsRequest{}
	if len(opts) > 0 {
		options = opts[0]
	}
...
func RegisterSimpleWorkflows(r worker.Registry, workflows SimpleWorkflows) {
...
func RegisterSimpleActivities(r worker.Registry, activities SimpleActivities) {
...
// SomeActivity1 does some activity thing.
func SomeActivity1(ctx workflow.Context, options ...*workflow.ActivityOptions) error {
...
func SomeActivity1Async(ctx workflow.Context, options ...*workflow.ActivityOptions) *SomeActivity1Future {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity1Local(ctx workflow.Context, fn func(context.Context) error, options ...*workflow.LocalActivityOptions) error {
...
func SomeActivity1LocalAsync(ctx workflow.Context, fn func(context.Context) error, options ...*workflow.LocalActivityOptions) *SomeActivity1Future {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
// SomeActivity2 does some activity thing.
func SomeActivity2(ctx workflow.Context, req *SomeActivity2Request, options ...*workflow.ActivityOptions) error {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity2Async(ctx workflow.Context, req *SomeActivity2Request, options ...*workflow.ActivityOptions) *SomeActivity2Future {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity2Local(ctx workflow.Context, fn func(context.Context, *SomeActivity2Request) error, req *SomeActivity2Request, options ...*workflow.LocalActivityOptions) error {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity2LocalAsync(ctx workflow.Context, fn func(context.Context, *SomeActivity2Request) error, req *SomeActivity2Request, options ...*workflow.LocalActivityOptions) *SomeActivity2Future {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
// SomeActivity3 does some activity thing.
func SomeActivity3(ctx workflow.Context, req *SomeActivity3Request, options ...*workflow.ActivityOptions) (*SomeActivity3Response, error) {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity3Async(ctx workflow.Context, req *SomeActivity3Request, options ...*workflow.ActivityOptions) *SomeActivity3Future {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity3Local(ctx workflow.Context, fn func(context.Context, *SomeActivity3Request) (*SomeActivity3Response, error), req *SomeActivity3Request, options ...*workflow.LocalActivityOptions) (*SomeActivity3Response, error) {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func SomeActivity3LocalAsync(ctx workflow.Context, fn func(context.Context, *SomeActivity3Request) (*SomeActivity3Response, error), req *SomeActivity3Request, options ...*workflow.LocalActivityOptions) *SomeActivity3Future {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
type OtherClient interface {
	...
	OtherWorkflow(ctx context.Context, req *OtherWorkflowRequest, opts ...*client.StartWorkflowOptions) (*OtherWorkflowResponse, error)
	// OtherWorkflowAsync executes a(n) mycompany.simple.Other.OtherWorkflow workflow asynchronously
	OtherWorkflowAsync(ctx context.Context, req *OtherWorkflowRequest, opts ...*client.StartWorkflowOptions) (OtherWorkflowRun, error)
	...
	OtherUpdate(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*client.UpdateWorkflowWithOptionsRequest) (*OtherUpdateResponse, error)
	// OtherUpdate executes a(n) mycompany.simple.Other.OtherUpdate update and blocks until update completion
	OtherUpdateAsync(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*client.UpdateWorkflowWithOptionsRequest) (OtherUpdateHandle, error)
}
...
func (c *otherClient) OtherWorkflow(ctx context.Context, req *OtherWorkflowRequest, options ...*client.StartWorkflowOptions) (*OtherWorkflowResponse, error) {
...
func (c *otherClient) OtherWorkflowAsync(ctx context.Context, req *OtherWorkflowRequest, options ...*client.StartWorkflowOptions) (OtherWorkflowRun, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *otherClient) OtherUpdate(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*client.UpdateWorkflowWithOptionsRequest) (*OtherUpdateResponse, error) {
	options := &client.UpdateWorkflowWithOptionsRequest{}
	if len(opts) > 0 {
		options = opts[0]
	}
...
func (c *otherClient) OtherUpdateAsync(ctx context.Context, workflowID string, runID string, req *OtherUpdateRequest, opts ...*client.UpdateWorkflowWithOptionsRequest) (OtherUpdateHandle, error) {
	options := &client.UpdateWorkflowWithOptionsRequest{}
	if len(opts) > 0 {
		options = opts[0]
	}
...
func RegisterOtherWorkflows(r worker.Registry, workflows OtherWorkflows) {
...
func RegisterOtherWorkflowWorkflow(r worker.Registry, wf func(workflow.Context, *OtherWorkflowInput) (OtherWorkflowWorkflow, error)) {
	r.RegisterWorkflowWithOptions(buildOtherWorkflow(wf), workflow.RegisterOptions{Name: OtherWorkflowWorkflowName})
}
...
func OtherWorkflowChild(ctx workflow.Context, req *OtherWorkflowRequest, options ...*workflow.ChildWorkflowOptions) (*OtherWorkflowResponse, error) {
...
func OtherWorkflowChildAsync(ctx workflow.Context, req *OtherWorkflowRequest, options ...*workflow.ChildWorkflowOptions) (*OtherWorkflowChildRun, error) {
	var opts *workflow.ChildWorkflowOptions
	if len(options) > 0 {
		opts = options[0]
	} else {
...
func OtherSignalExternal(ctx workflow.Context, workflowID string, runID string, req *OtherSignalRequest) error {
	return workflow.SignalExternalWorkflow(ctx, workflowID, runID, OtherSignalSignalName, req).Get(ctx, nil)
}
...
func RegisterOtherActivities(r worker.Registry, activities OtherActivities) {
...
func RegisterOtherWorkflowActivity(r worker.Registry, fn func(context.Context, *OtherWorkflowRequest) (*OtherWorkflowResponse, error)) {
	r.RegisterActivityWithOptions(fn, activity.RegisterOptions{
...
func OtherWorkflow(ctx workflow.Context, req *OtherWorkflowRequest, options ...*workflow.ActivityOptions) (*OtherWorkflowResponse, error) {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func OtherWorkflowAsync(ctx workflow.Context, req *OtherWorkflowRequest, options ...*workflow.ActivityOptions) *OtherWorkflowFuture {
	var opts *workflow.ActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func OtherWorkflowLocal(ctx workflow.Context, fn func(context.Context, *OtherWorkflowRequest) (*OtherWorkflowResponse, error), req *OtherWorkflowRequest, options ...*workflow.LocalActivityOptions) (*OtherWorkflowResponse, error) {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
...
func OtherWorkflowLocalAsync(ctx workflow.Context, fn func(context.Context, *OtherWorkflowRequest) (*OtherWorkflowResponse, error), req *OtherWorkflowRequest, options ...*workflow.LocalActivityOptions) *OtherWorkflowFuture {
	var opts *workflow.LocalActivityOptions
	if len(options) > 0 && options[0] != nil {
		opts = options[0]
	} else {
