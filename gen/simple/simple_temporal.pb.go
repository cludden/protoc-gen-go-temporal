...
// SomeWorkflow1 does some workflow thing.
//
// workflow.name: mycompany.simple.Simple.SomeWorkflow1
// workflow.id: some-workflow-1/${! id }/${! uuid_v4() }
...
// SomeWorkflow2 does some workflow thing.
//
// workflow.name: mycompany.simple.Simple.SomeWorkflow2
...
// SomeWorkflow3 does some workflow thing.
//
// workflow.name: mycompany.simple.Simple.SomeWorkflow3
// workflow.id: some-workflow-3/${! id }/${! requestVal }
