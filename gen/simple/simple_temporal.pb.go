...
// versions:
//
//	protoc-gen-go_temporal 0.8.1-next (e3df465c4b84e31e91d1981127e98af356b9727e)
//	go go1.20.4
//	protoc (unknown)
//
...
// WithStartWorkflowOptions sets the initial client.StartWorkflowOptions
func (opts *SomeWorkflow1ChildOptions) WithStartWorkflowOptions(options workflow.ChildWorkflowOptions) *SomeWorkflow1ChildOptions {
	opts.opts = &options
	return opts
}
...
// WithStartWorkflowOptions sets the initial client.StartWorkflowOptions
func (opts *SomeWorkflow2ChildOptions) WithStartWorkflowOptions(options workflow.ChildWorkflowOptions) *SomeWorkflow2ChildOptions {
	opts.opts = &options
	return opts
}
...
// WithStartWorkflowOptions sets the initial client.StartWorkflowOptions
func (opts *SomeWorkflow3ChildOptions) WithStartWorkflowOptions(options workflow.ChildWorkflowOptions) *SomeWorkflow3ChildOptions {
	opts.opts = &options
	return opts
}
...
// WithStartWorkflowOptions sets the initial client.StartWorkflowOptions
func (opts *OtherWorkflowChildOptions) WithStartWorkflowOptions(options workflow.ChildWorkflowOptions) *OtherWorkflowChildOptions {
	opts.opts = &options
	return opts
}
