...
func (c *simpleClient) SomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*SomeUpdate1Options) (*SomeUpdate1Response, error) {
	...
	if options.opts == nil {
		options.opts = &client.UpdateWorkflowWithOptionsRequest{}
	}
...
// SomeWorkflow1 does some workflow thing.
//
// workflow details: (name: "mycompany.simple.Simple.SomeWorkflow1", id: "some-workflow-1/${! id }/${! uuid_v4() }")
...
// SomeWorkflow2 does some workflow thing.
//
// workflow details: (name: "mycompany.simple.Simple.SomeWorkflow2")
...
type OtherClient interface {
	...
	// OtherUpdate starts a(n) mycompany.simple.Other.OtherUpdate update and returns a handle to the workflow update
...
type OtherActivities interface {
	// OtherWorkflow implements a(n) mycompany.simple.Other.OtherWorkflow activity definition
...
type OnlyActivitiesActivities interface {
	// LonelyActivity1 implements a(n) mycompany.simple.OnlyActivities.LonelyActivity1 activity definition
...
func NewSomeDeprecatedUpdate1Options() *SomeDeprecatedUpdate1Options {
	return &SomeDeprecatedUpdate1Options{opts: &client.UpdateWorkflowWithOptionsRequest{}}
}
...
func NewSomeDeprecatedUpdate2Options() *SomeDeprecatedUpdate2Options {
	return &SomeDeprecatedUpdate2Options{opts: &client.UpdateWorkflowWithOptionsRequest{}}
}
...
// SomeDeprecatedWorkflow1ChildRun describes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow1 workflow run
...
// SomeDeprecatedWorkflow2ChildRun describes a child mycompany.simple.Deprecated.SomeDeprecatedWorkflow2 workflow run
...
// SomeDeprecatedWorkflow1 executes a(n) SomeDeprecatedWorkflow1 workflow in the test environment
...
// SomeDeprecatedWorkflow1Async executes a(n) SomeDeprecatedWorkflow1 workflow in the test environment
...
// SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1 sends a(n) SomeDeprecatedSignal1 signal to a(n) SomeDeprecatedWorkflow1 workflow, starting it if necessary
...
// SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1Async sends a(n) SomeDeprecatedSignal1 signal to a(n) SomeDeprecatedWorkflow1 workflow, starting it if necessary
...
// SomeDeprecatedWorkflow2 executes a(n) SomeDeprecatedWorkflow2 workflow in the test environment
...
// SomeDeprecatedWorkflow2Async executes a(n) SomeDeprecatedWorkflow2 workflow in the test environment
...
// SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2 sends a(n) SomeDeprecatedSignal2 signal to a(n) SomeDeprecatedWorkflow2 workflow, starting it if necessary
...
// SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2Async sends a(n) SomeDeprecatedSignal2 signal to a(n) SomeDeprecatedWorkflow2 workflow, starting it if necessary
...
// SomeDeprecatedSignal1 executes a SomeDeprecatedSignal1 signal
...
// SomeDeprecatedSignal2 executes a SomeDeprecatedSignal2 signal
...
// testSomeDeprecatedWorkflow1Run provides convenience methods for interacting with a(n) SomeDeprecatedWorkflow1 workflow in the test environment
...
// Get retrieves a test SomeDeprecatedWorkflow1 workflow result
...
// ID returns a test SomeDeprecatedWorkflow1 workflow run's workflow ID
...
// SomeDeprecatedQuery1 executes a SomeDeprecatedQuery1 query against a test SomeDeprecatedWorkflow1 workflow
...
// SomeDeprecatedSignal1 executes a SomeDeprecatedSignal1 signal against a test SomeDeprecatedWorkflow1 workflow
...
// testSomeDeprecatedWorkflow2Run provides convenience methods for interacting with a(n) SomeDeprecatedWorkflow2 workflow in the test environment
...
// Get retrieves a test SomeDeprecatedWorkflow2 workflow result
...
// ID returns a test SomeDeprecatedWorkflow2 workflow run's workflow ID
...
// SomeDeprecatedQuery2 executes a SomeDeprecatedQuery2 query against a test SomeDeprecatedWorkflow2 workflow
...
// SomeDeprecatedSignal2 executes a SomeDeprecatedSignal2 signal against a test SomeDeprecatedWorkflow2 workflow
...
func newDeprecatedCommands(options ...*DeprecatedCliOptions) ([]*v2.Command, error) {
	...
	commands := []*v2.Command{
		...
		// sends a SomeDeprecatedSignal1 signal to a SomeDeprecatedWorkflow1 workflow, starting it if necessary,
		{
			Name:                   "some-deprecated-workflow-1-with-some-deprecated-signal-1",
			Usage:                  "sends a SomeDeprecatedSignal1 signal to a SomeDeprecatedWorkflow1 workflow, starting it if necessary",
			Category:               "WORKFLOWS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
		...
		// sends a SomeDeprecatedSignal2 signal to a SomeDeprecatedWorkflow2 workflow, starting it if necessary,
		{
			Name:                   "some-deprecated-workflow-2-with-some-deprecated-signal-2",
			Usage:                  "sends a SomeDeprecatedSignal2 signal to a SomeDeprecatedWorkflow2 workflow, starting it if necessary",
			Category:               "WORKFLOWS",
			UseShortOptionHandling: true,
			Before:                 opts.before,
			After:                  opts.after,
