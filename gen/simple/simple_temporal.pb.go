...
type IgnoredWorkflows interface {
	What(ctx workflow.Context, input *WhatInput) (WhatWorkflow, error)
}
...
func RegisterWhatWorkflow(r worker.WorkflowRegistry, wf func(workflow.Context, *WhatInput) (WhatWorkflow, error)) {
...
func buildWhat(ctor func(workflow.Context, *WhatInput) (WhatWorkflow, error)) func(workflow.Context, *WhatRequest) error {
...
// WhatInput describes the input to a(n) mycompany.simple.Ignored.What workflow constructor
