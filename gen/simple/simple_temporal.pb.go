...
type SomeWorkflow1Workflow interface {
	// Execute defines the entrypoint to a(n) mycompany.simple.Simple.SomeWorkflow1 workflow
...
type SomeWorkflow2Workflow interface {
	// Execute defines the entrypoint to a(n) mycompany.simple.Simple.SomeWorkflow2 workflow
