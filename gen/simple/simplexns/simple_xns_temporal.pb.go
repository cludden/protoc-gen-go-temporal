...
// SomeWorkflow1WorkflowOptions are used to configure a(n) mycompany.simple.Simple.SomeWorkflow1 workflow execution
...
// SomeWorkflow1Run provides a handle to a mycompany.simple.Simple.SomeWorkflow1 workflow execution
...
// SomeWorkflow2WorkflowOptions are used to configure a(n) mycompany.simple.Simple.SomeWorkflow2 workflow execution
...
// SomeWorkflow2Run provides a handle to a mycompany.simple.Simple.SomeWorkflow2 workflow execution
...
func (a *simpleActivities) SomeUpdate1(ctx context.Context, input *v1.UpdateRequest) (resp *simple.SomeUpdate1Response, err error) {
	var handle simple.SomeUpdate1Handle
	if activity.HasHeartbeatDetails(ctx) {
		...
		uo.WaitPolicy = &v11.WaitPolicy{
			LifecycleStage: v12.UPDATE_WORKFLOW_EXECUTION_LIFECYCLE_STAGE_ACCEPTED,
		}
		...
		handle, err = a.client.SomeUpdate1Async(
			...
			&req,
			simple.NewSomeUpdate1Options().WithUpdateWorkflowOptions(uo),
		)
		if err != nil {
			return nil, err
		}
...
func (a *otherActivities) OtherUpdate(ctx context.Context, input *v1.UpdateRequest) (resp *simple.OtherUpdateResponse, err error) {
	var handle simple.OtherUpdateHandle
	if activity.HasHeartbeatDetails(ctx) {
		// extract update id from heartbeat details
		var updateID string
		if err := activity.GetHeartbeatDetails(ctx, &updateID); err != nil {
		...
		handle, err = a.client.OtherUpdateAsync(
			...
			input.GetUpdateWorkflowOptions().GetRunId(),
			&req,
			simple.NewOtherUpdateOptions().WithUpdateWorkflowOptions(uo),
		)
		if err != nil {
			return nil, err
		}
...
func (a *deprecatedActivities) SomeDeprecatedUpdate1(ctx context.Context, input *v1.UpdateRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	...
	var handle simple.SomeDeprecatedUpdate1Handle
	if activity.HasHeartbeatDetails(ctx) {
		// extract update id from heartbeat details
		var updateID string
		if err := activity.GetHeartbeatDetails(ctx, &updateID); err != nil {
		...
		handle, err = a.client.SomeDeprecatedUpdate1Async(
			...
			input.GetUpdateWorkflowOptions().GetRunId(),
			&req,
			simple.NewSomeDeprecatedUpdate1Options().WithUpdateWorkflowOptions(uo),
		)
		if err != nil {
			return nil, err
		}
...
func (a *deprecatedActivities) SomeDeprecatedUpdate2(ctx context.Context, input *v1.UpdateRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	...
	var handle simple.SomeDeprecatedUpdate2Handle
	if activity.HasHeartbeatDetails(ctx) {
		// extract update id from heartbeat details
		var updateID string
		if err := activity.GetHeartbeatDetails(ctx, &updateID); err != nil {
		...
		handle, err = a.client.SomeDeprecatedUpdate2Async(
			...
			input.GetUpdateWorkflowOptions().GetRunId(),
			&req,
			simple.NewSomeDeprecatedUpdate2Options().WithUpdateWorkflowOptions(uo),
		)
		if err != nil {
			return nil, err
		}
