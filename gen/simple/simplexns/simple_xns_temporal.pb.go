...
// versions:
//
//	protoc-gen-go_temporal 1.9.1-next (42b5da62e551bb7fca19a30d8d65c06bd2403b46)
//	go go1.22.1
//	protoc (unknown)
//
...
// SomeWorkflow2WithSomeSignal1 sends a(n) mycompany.simple.Simple.SomeSignal1 signal to a mycompany.simple.Simple.SomeWorkflow2 workflow, starting it if necessary, and blocks until the workflow completes
...
// SomeWorkflow2WithSomeSignal1Async sends a(n) mycompany.simple.Simple.SomeSignal1 signal to a(n) mycompany.simple.Simple.SomeWorkflow2 workflow, starting it if necessary, and returns a handle to the underlying activity
...
func SomeWorkflow3Async(ctx workflow.Context, req *simple.SomeWorkflow3Request, opts ...*SomeWorkflow3WorkflowOptions) (SomeWorkflow3Run, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeWorkflow3WorkflowName)
...
func (a *simpleActivities) SomeWorkflow3(ctx context.Context, input *v1.WorkflowRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeWorkflow3WorkflowName)
...
// filter is used to filter xns activity registrations
func (opts *DeprecatedOptions) filter(name string) string {
	if opts == nil || opts.Filter == nil {
		return name
	}
	return opts.Filter(name)
...
func RegisterDeprecatedActivities(r worker.ActivityRegistry, c simple.DeprecatedClient, opts ...DeprecatedOptions) {
	if len(opts) > 0 {
		deprecatedOptions = &opts[0]
	}
	a := &deprecatedActivities{c}
	if name := deprecatedOptions.filter("mycompany.simple.Deprecated.CancelWorkflow"); name != "" {
		r.RegisterActivityWithOptions(a.CancelWorkflow, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedWorkflow1WorkflowName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedWorkflow1, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter("mycompany.simple.Deprecated.SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1"); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedWorkflow2WorkflowName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedWorkflow2, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter("mycompany.simple.Deprecated.SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2"); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedQuery1QueryName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedQuery1, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedQuery2QueryName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedQuery2, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedSignal1SignalName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedSignal1, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedSignal2SignalName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedSignal2, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedUpdate1UpdateName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedUpdate1, activity.RegisterOptions{Name: name})
	}
	if name := deprecatedOptions.filter(simple.SomeDeprecatedUpdate2UpdateName); name != "" {
		r.RegisterActivityWithOptions(a.SomeDeprecatedUpdate2, activity.RegisterOptions{Name: name})
	}
}

// SomeDeprecatedWorkflow1WorkflowOptions are used to configure a(n) SomeDeprecatedWorkflow1 workflow execution
...
// SomeDeprecatedWorkflow1Run provides a handle to a SomeDeprecatedWorkflow1 workflow execution
type SomeDeprecatedWorkflow1Run interface {
	...
	// Get returns the inner workflow.Future
	Get(workflow.Context) (*simple.SomeDeprecatedMessage, error)
	...
	//
	// Deprecated: Do not use.
	SomeDeprecatedQuery1(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedQuery1QueryOptions) (*simple.SomeDeprecatedMessage, error)

	// SomeDeprecatedQuery1 does something else
	//
	// Deprecated: Do not use.
	SomeDeprecatedQuery1Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedQuery1QueryOptions) (SomeDeprecatedQuery1QueryHandle, error)

	// SomeDeprecatedSignal1 does something else
	//
	// Deprecated: Do not use.
	SomeDeprecatedSignal1(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedSignal1SignalOptions) error

	// SomeDeprecatedSignal1 does something else
	//
	// Deprecated: Do not use.
	SomeDeprecatedSignal1Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedSignal1SignalOptions) (SomeDeprecatedSignal1SignalHandle, error)

	// SomeDeprecatedUpdate1 does something else
	//
	// Deprecated: Do not use.
	SomeDeprecatedUpdate1(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedUpdate1UpdateOptions) (*simple.SomeDeprecatedMessage, error)

	// SomeDeprecatedUpdate1 does something else
	//
	// Deprecated: Do not use.
	SomeDeprecatedUpdate1Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedUpdate1UpdateOptions) (SomeDeprecatedUpdate1Handle, error)
}
...
// Get blocks on activity completion and returns the underlying workflow result
func (r *someDeprecatedWorkflow1Run) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedQuery1(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery1QueryOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedQuery1Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery1QueryOptions) (SomeDeprecatedQuery1QueryHandle, error) {
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedSignal1(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal1SignalOptions) error {
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedSignal1Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal1SignalOptions) (SomeDeprecatedSignal1SignalHandle, error) {
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedUpdate1(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1UpdateOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: Do not use.
func (r *someDeprecatedWorkflow1Run) SomeDeprecatedUpdate1Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1UpdateOptions) (SomeDeprecatedUpdate1Handle, error) {
	return SomeDeprecatedUpdate1Async(ctx, r.ID(), "", req, opts...)
}

// SomeDeprecatedWorkflow1 does something
func SomeDeprecatedWorkflow1(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow1WorkflowOptions) (*simple.SomeDeprecatedMessage, error) {
...
// SomeDeprecatedWorkflow1 does something
func SomeDeprecatedWorkflow1Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow1WorkflowOptions) (SomeDeprecatedWorkflow1Run, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow1WorkflowName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedWorkflow1WorkflowName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedWorkflow1WorkflowName),
			"Unimplemented",
			nil,
		)
	}

	opt := &SomeDeprecatedWorkflow1WorkflowOptions{}
	if len(opts) > 0 && opts[0] != nil {
		opt = opts[0]
	}
	if opt.HeartbeatInterval == 0 {
...
//
// Deprecated: Do not use.
func SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1(ctx workflow.Context, req *simple.SomeDeprecatedMessage, signal *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow1WorkflowOptions) (*simple.SomeDeprecatedMessage, error) {
	run, err := SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1Async(ctx, req, signal, opts...)
	if err != nil {
		return nil, err
	}
	return run.Get(ctx)
...
//
// Deprecated: Do not use.
func SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, signal *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow1WorkflowOptions) (SomeDeprecatedWorkflow1Run, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow1WorkflowName)
	workflow.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal1SignalName)

	activityName := deprecatedOptions.filter("mycompany.simple.Deprecated.SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1")
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
...
// SomeDeprecatedWorkflow2WorkflowOptions are used to configure a(n) SomeDeprecatedWorkflow2 workflow execution
...
// SomeDeprecatedWorkflow2Run provides a handle to a SomeDeprecatedWorkflow2 workflow execution
type SomeDeprecatedWorkflow2Run interface {
	...
	SomeDeprecatedQuery2(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedQuery2QueryOptions) (*simple.SomeDeprecatedMessage, error)

	// SomeDeprecatedQuery2 does something else
	//
	// Deprecated: a custom query deprecation message.
	SomeDeprecatedQuery2Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedQuery2QueryOptions) (SomeDeprecatedQuery2QueryHandle, error)

	// SomeDeprecatedSignal2 does something else
	//
	// Deprecated: a custom signal deprecation message.
	SomeDeprecatedSignal2(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedSignal2SignalOptions) error

	// SomeDeprecatedSignal2 does something else
	//
	// Deprecated: a custom signal deprecation message.
	SomeDeprecatedSignal2Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedSignal2SignalOptions) (SomeDeprecatedSignal2SignalHandle, error)

	// SomeDeprecatedUpdate2 does something else
	//
	// Deprecated: a custom signal deprecation message.
	SomeDeprecatedUpdate2(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedUpdate2UpdateOptions) (*simple.SomeDeprecatedMessage, error)

	// SomeDeprecatedUpdate2 does something else
	//
	// Deprecated: a custom signal deprecation message.
	SomeDeprecatedUpdate2Async(workflow.Context, *simple.SomeDeprecatedMessage, ...*SomeDeprecatedUpdate2UpdateOptions) (SomeDeprecatedUpdate2Handle, error)
}
...
// Get blocks on activity completion and returns the underlying workflow result
func (r *someDeprecatedWorkflow2Run) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
...
//
// Deprecated: a custom query deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedQuery2(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery2QueryOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: a custom query deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedQuery2Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery2QueryOptions) (SomeDeprecatedQuery2QueryHandle, error) {
...
//
// Deprecated: a custom signal deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedSignal2(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal2SignalOptions) error {
...
//
// Deprecated: a custom signal deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedSignal2Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal2SignalOptions) (SomeDeprecatedSignal2SignalHandle, error) {
...
//
// Deprecated: a custom signal deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedUpdate2(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2UpdateOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: a custom signal deprecation message.
func (r *someDeprecatedWorkflow2Run) SomeDeprecatedUpdate2Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2UpdateOptions) (SomeDeprecatedUpdate2Handle, error) {
...
func SomeDeprecatedWorkflow2(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow2WorkflowOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: a custom workflow deprecation message.
func SomeDeprecatedWorkflow2Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow2WorkflowOptions) (SomeDeprecatedWorkflow2Run, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow2WorkflowName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedWorkflow2WorkflowName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedWorkflow2WorkflowName),
			"Unimplemented",
			nil,
		)
	}

	opt := &SomeDeprecatedWorkflow2WorkflowOptions{}
	if len(opts) > 0 && opts[0] != nil {
		opt = opts[0]
	}
	if opt.HeartbeatInterval == 0 {
...
//
// Deprecated: Do not use.
func SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2(ctx workflow.Context, req *simple.SomeDeprecatedMessage, signal *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow2WorkflowOptions) (*simple.SomeDeprecatedMessage, error) {
	run, err := SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2Async(ctx, req, signal, opts...)
	if err != nil {
		return nil, err
	}
	return run.Get(ctx)
...
//
// Deprecated: Do not use.
func SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2Async(ctx workflow.Context, req *simple.SomeDeprecatedMessage, signal *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedWorkflow2WorkflowOptions) (SomeDeprecatedWorkflow2Run, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow2WorkflowName)
	workflow.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal2SignalName)

	activityName := deprecatedOptions.filter("mycompany.simple.Deprecated.SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2")
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
...
// SomeDeprecatedQuery1QueryHandle provides a handle for a SomeDeprecatedQuery1 query activity
...
// Get blocks on activity completion and returns the underlying query result
func (r *someDeprecatedQuery1QueryHandle) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
...
//
// Deprecated: Do not use.
func SomeDeprecatedQuery1(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery1QueryOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: Do not use.
func SomeDeprecatedQuery1Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery1QueryOptions) (SomeDeprecatedQuery1QueryHandle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated query detected", "query", simple.SomeDeprecatedQuery1QueryName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedQuery1QueryName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedQuery1QueryName),
			"Unimplemented",
			nil,
		)
	}
...
// SomeDeprecatedQuery2QueryHandle provides a handle for a SomeDeprecatedQuery2 query activity
...
// Get blocks on activity completion and returns the underlying query result
func (r *someDeprecatedQuery2QueryHandle) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
...
//
// Deprecated: a custom query deprecation message.
func SomeDeprecatedQuery2(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery2QueryOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: a custom query deprecation message.
func SomeDeprecatedQuery2Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedQuery2QueryOptions) (SomeDeprecatedQuery2QueryHandle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated query detected", "query", simple.SomeDeprecatedQuery2QueryName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedQuery2QueryName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedQuery2QueryName),
			"Unimplemented",
			nil,
		)
	}
...
// SomeDeprecatedSignal1SignalHandle provides a handle for a SomeDeprecatedSignal1 signal activity
...
//
// Deprecated: Do not use.
func SomeDeprecatedSignal1(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal1SignalOptions) error {
...
//
// Deprecated: Do not use.
func SomeDeprecatedSignal1Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal1SignalOptions) (SomeDeprecatedSignal1SignalHandle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal1SignalName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedSignal1SignalName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedSignal1SignalName),
			"Unimplemented",
			nil,
		)
	}
...
// SomeDeprecatedSignal2SignalHandle provides a handle for a SomeDeprecatedSignal2 signal activity
...
//
// Deprecated: a custom signal deprecation message.
func SomeDeprecatedSignal2(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal2SignalOptions) error {
...
//
// Deprecated: a custom signal deprecation message.
func SomeDeprecatedSignal2Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedSignal2SignalOptions) (SomeDeprecatedSignal2SignalHandle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal2SignalName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedSignal2SignalName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedSignal2SignalName),
			"Unimplemented",
			nil,
		)
	}
...
// SomeDeprecatedUpdate1UpdateOptions are used to configure a(n) SomeDeprecatedUpdate1 update execution
...
// WithUpdateWorkflowOptions can be used to customize the update workflow options
func (opts *SomeDeprecatedUpdate1UpdateOptions) WithUpdateWorkflowOptions(uwo client.UpdateWorkflowWithOptionsRequest) *SomeDeprecatedUpdate1UpdateOptions {
	opts.UpdateWorkflowOptions = &uwo
	return opts
}

// SomeDeprecatedUpdate1Handle provides a handle to a SomeDeprecatedUpdate1 workflow update
...
// Get blocks on activity completion and returns the underlying update result
func (r *someDeprecatedUpdate1Handle) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
...
//
// Deprecated: Do not use.
func SomeDeprecatedUpdate1(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1UpdateOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: Do not use.
func SomeDeprecatedUpdate1Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate1UpdateOptions) (SomeDeprecatedUpdate1Handle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated update detected", "update", simple.SomeDeprecatedUpdate1UpdateName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedUpdate1UpdateName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedUpdate1UpdateName),
			"Unimplemented",
			nil,
		)
	}

	opt := &SomeDeprecatedUpdate1UpdateOptions{}
	if len(opts) > 0 && opts[0] != nil {
		opt = opts[0]
	}
...
// SomeDeprecatedUpdate2UpdateOptions are used to configure a(n) SomeDeprecatedUpdate2 update execution
...
// WithUpdateWorkflowOptions can be used to customize the update workflow options
func (opts *SomeDeprecatedUpdate2UpdateOptions) WithUpdateWorkflowOptions(uwo client.UpdateWorkflowWithOptionsRequest) *SomeDeprecatedUpdate2UpdateOptions {
	opts.UpdateWorkflowOptions = &uwo
	return opts
}

// SomeDeprecatedUpdate2Handle provides a handle to a SomeDeprecatedUpdate2 workflow update
...
// Get blocks on activity completion and returns the underlying update result
func (r *someDeprecatedUpdate2Handle) Get(ctx workflow.Context) (*simple.SomeDeprecatedMessage, error) {
	var resp simple.SomeDeprecatedMessage
	if err := r.future.Get(ctx, &resp); err != nil {
		return nil, err
	}
...
//
// Deprecated: a custom signal deprecation message.
func SomeDeprecatedUpdate2(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2UpdateOptions) (*simple.SomeDeprecatedMessage, error) {
...
//
// Deprecated: a custom signal deprecation message.
func SomeDeprecatedUpdate2Async(ctx workflow.Context, workflowID string, runID string, req *simple.SomeDeprecatedMessage, opts ...*SomeDeprecatedUpdate2UpdateOptions) (SomeDeprecatedUpdate2Handle, error) {
	workflow.GetLogger(ctx).Warn("use of deprecated update detected", "update", simple.SomeDeprecatedUpdate2UpdateName)

	activityName := deprecatedOptions.filter(simple.SomeDeprecatedUpdate2UpdateName)
	if activityName == "" {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("no activity registered for %s", simple.SomeDeprecatedUpdate2UpdateName),
			"Unimplemented",
			nil,
		)
	}

	opt := &SomeDeprecatedUpdate2UpdateOptions{}
	if len(opts) > 0 && opts[0] != nil {
		opt = opts[0]
	}
...
func CancelDeprecatedWorkflowAsync(ctx workflow.Context, workflowID string, runID string) workflow.Future {
	activityName := deprecatedOptions.filter("mycompany.simple.Deprecated.CancelWorkflow")
	if activityName == "" {
		f, s := workflow.NewFuture(ctx)
		s.SetError(temporal.NewNonRetryableApplicationError(
...
type deprecatedActivities struct {
	client simple.DeprecatedClient
}
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1(ctx context.Context, input *v1.WorkflowRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow1WorkflowName)

	// unmarshal workflow request
	var req simple.SomeDeprecatedMessage
	if err := input.Request.UnmarshalTo(&req); err != nil {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("error unmarshalling workflow request of type %s as github.com/cludden/protoc-gen-go-temporal/gen/simple.SomeDeprecatedMessage", input.Request.GetTypeUrl()),
			"InvalidArgument",
			err,
		)
	}
	...
	// initialize workflow execution
	var run simple.SomeDeprecatedWorkflow1Run
	run, err = a.client.SomeDeprecatedWorkflow1Async(ctx, &req, simple.NewSomeDeprecatedWorkflow1Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, err
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1(ctx context.Context, input *v1.WorkflowRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow1WorkflowName)
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal1SignalName)
	...
	// unmarshal signal request
	var signal simple.SomeDeprecatedMessage
	if err := input.Signal.UnmarshalTo(&signal); err != nil {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("error unmarshalling signal request of type %s as github.com/cludden/protoc-gen-go-temporal/gen/simple.SomeDeprecatedMessage", input.Signal.GetTypeUrl()),
			"InvalidArgument",
			err,
		)
	}
	...
	// initialize workflow execution
	var run simple.SomeDeprecatedWorkflow1Run
	run, err = a.client.SomeDeprecatedWorkflow1WithSomeDeprecatedSignal1Async(ctx, &req, &signal, simple.NewSomeDeprecatedWorkflow1Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, err
...
//
// Deprecated: a custom workflow deprecation message.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2(ctx context.Context, input *v1.WorkflowRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow2WorkflowName)
	...
	// initialize workflow execution
	var run simple.SomeDeprecatedWorkflow2Run
	run, err = a.client.SomeDeprecatedWorkflow2Async(ctx, &req, simple.NewSomeDeprecatedWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, err
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2(ctx context.Context, input *v1.WorkflowRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated workflow detected", "workflow", simple.SomeDeprecatedWorkflow2WorkflowName)
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal2SignalName)
	...
	// initialize workflow execution
	var run simple.SomeDeprecatedWorkflow2Run
	run, err = a.client.SomeDeprecatedWorkflow2WithSomeDeprecatedSignal2Async(ctx, &req, &signal, simple.NewSomeDeprecatedWorkflow2Options().WithStartWorkflowOptions(
		xns.UnmarshalStartWorkflowOptions(input.GetStartWorkflowOptions()),
	))
	if err != nil {
		return nil, err
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedQuery1(ctx context.Context, input *v1.QueryRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated query detected", "query", simple.SomeDeprecatedQuery1QueryName)

	// unmarshal query request
	var req simple.SomeDeprecatedMessage
	if err := input.Request.UnmarshalTo(&req); err != nil {
		return nil, temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("error unmarshalling query request of type %s as github.com/cludden/protoc-gen-go-temporal/gen/simple.SomeDeprecatedMessage", input.Request.GetTypeUrl()),
			"InvalidArgument",
			err,
		)
	}
...
//
// Deprecated: a custom query deprecation message.
func (a *deprecatedActivities) SomeDeprecatedQuery2(ctx context.Context, input *v1.QueryRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated query detected", "query", simple.SomeDeprecatedQuery2QueryName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedSignal1(ctx context.Context, input *v1.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal1SignalName)
	...
	if err := input.Request.UnmarshalTo(&req); err != nil {
		return temporal.NewNonRetryableApplicationError(
			fmt.Sprintf("error unmarshalling signal request of type %s as github.com/cludden/protoc-gen-go-temporal/gen/simple.SomeDeprecatedMessage", input.Request.GetTypeUrl()),
			"InvalidArgument",
			err,
		)
	}
...
//
// Deprecated: a custom signal deprecation message.
func (a *deprecatedActivities) SomeDeprecatedSignal2(ctx context.Context, input *v1.SignalRequest) (err error) {
	activity.GetLogger(ctx).Warn("use of deprecated signal detected", "signal", simple.SomeDeprecatedSignal2SignalName)
...
//
// Deprecated: Do not use.
func (a *deprecatedActivities) SomeDeprecatedUpdate1(ctx context.Context, input *v1.UpdateRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated update detected", "update", simple.SomeDeprecatedUpdate1UpdateName)

	var update simple.SomeDeprecatedUpdate1Handle
	if activity.HasHeartbeatDetails(ctx) {
		// extract update id from heartbeat details
		var updateID string
		if err := activity.GetHeartbeatDetails(ctx, &updateID); err != nil {
		...
		// retrieve handle for existing update
		update, err = a.client.GetSomeDeprecatedUpdate1(ctx, client.GetWorkflowUpdateHandleOptions{
			WorkflowID: input.GetUpdateWorkflowOptions().GetWorkflowId(),
			RunID:      input.GetUpdateWorkflowOptions().GetRunId(),
			UpdateID:   updateID,
		})
		...
		if err := input.Request.UnmarshalTo(&req); err != nil {
			return nil, temporal.NewNonRetryableApplicationError(
				fmt.Sprintf("error unmarshalling update request of type %s as github.com/cludden/protoc-gen-go-temporal/gen/simple.SomeDeprecatedMessage", input.Request.GetTypeUrl()),
				"InvalidArgument",
				err,
			)
		}
		...
		// initialize update execution
		update, err = a.client.SomeDeprecatedUpdate1Async(
			ctx,
			input.GetUpdateWorkflowOptions().GetWorkflowId(),
			input.GetUpdateWorkflowOptions().GetRunId(),
			&req,
			simple.NewSomeDeprecatedUpdate1Options().WithUpdateWorkflowOptions(
				xns.UnmarshalUpdateWorkflowOptions(input.GetUpdateWorkflowOptions()),
			),
		)
		if err != nil {
...
//
// Deprecated: a custom signal deprecation message.
func (a *deprecatedActivities) SomeDeprecatedUpdate2(ctx context.Context, input *v1.UpdateRequest) (resp *simple.SomeDeprecatedMessage, err error) {
	activity.GetLogger(ctx).Warn("use of deprecated update detected", "update", simple.SomeDeprecatedUpdate2UpdateName)

	var update simple.SomeDeprecatedUpdate2Handle
	if activity.HasHeartbeatDetails(ctx) {
		// extract update id from heartbeat details
		var updateID string
		if err := activity.GetHeartbeatDetails(ctx, &updateID); err != nil {
		...
		// retrieve handle for existing update
		update, err = a.client.GetSomeDeprecatedUpdate2(ctx, client.GetWorkflowUpdateHandleOptions{
			WorkflowID: input.GetUpdateWorkflowOptions().GetWorkflowId(),
			RunID:      input.GetUpdateWorkflowOptions().GetRunId(),
			UpdateID:   updateID,
		})
		...
		// initialize update execution
		update, err = a.client.SomeDeprecatedUpdate2Async(
			ctx,
			input.GetUpdateWorkflowOptions().GetWorkflowId(),
			input.GetUpdateWorkflowOptions().GetRunId(),
			&req,
			simple.NewSomeDeprecatedUpdate2Options().WithUpdateWorkflowOptions(
				xns.UnmarshalUpdateWorkflowOptions(input.GetUpdateWorkflowOptions()),
			),
		)
		if err != nil {
