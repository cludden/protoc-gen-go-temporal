...
const (
	MutexWorkflowName                   = "mycompany.mutex.Mutex.MutexWorkflow"
	SampleWorkflowWithMutexWorkflowName = "mycompany.mutex.Mutex.SampleWorkflowWithMutexWorkflow"
)
...
const (
	MutexActivityName = "mycompany.mutex.Mutex.MutexActivity"
)

// Mutex signal names
const (
	AcquireLeaseSignalName  = "mycompany.mutex.Mutex.AcquireLeaseSignal"
	LeaseAcquiredSignalName = "mycompany.mutex.Mutex.LeaseAcquiredSignal"
	RenewLeaseSignalName    = "mycompany.mutex.Mutex.RenewLeaseSignal"
	RevokeLeaseSignalName   = "mycompany.mutex.Mutex.RevokeLeaseSignal"
)
...
type Client interface {
	...
	// StartMutex starts a(n) Mutex workflow
	ExecuteMutex(ctx context.Context, req *MutexRequest, opts ...*client.StartWorkflowOptions) (MutexRun, error)
	// GetMutex retrieves a(n) Mutex workflow execution
	GetMutex(ctx context.Context, workflowID string, runID string) (MutexRun, error)
	// StartMutexWithAcquireLease sends a(n) AcquireLease signal to a Mutex workflow, starting it if not present
	StartMutexWithAcquireLease(ctx context.Context, req *MutexRequest, signal *AcquireLeaseRequest, opts ...*client.StartWorkflowOptions) (MutexRun, error)
	...
	// StartSampleWorkflowWithMutex starts a(n) SampleWorkflowWithMutex workflow
	ExecuteSampleWorkflowWithMutex(ctx context.Context, req *SampleWorkflowWithMutexRequest, opts ...*client.StartWorkflowOptions) (SampleWorkflowWithMutexRun, error)
	// GetSampleWorkflowWithMutex retrieves a(n) SampleWorkflowWithMutex workflow execution
...
func (c *workflowClient) Mutex(ctx context.Context, req *MutexRequest, options ...*client.StartWorkflowOptions) error {
	run, err := c.ExecuteMutex(ctx, req, options...)
	if err != nil {
		return err
	}
	return run.Get(ctx)
...
func (c *workflowClient) ExecuteMutex(ctx context.Context, req *MutexRequest, options ...*client.StartWorkflowOptions) (MutexRun, error) {
...
func (c *workflowClient) StartMutexWithAcquireLease(ctx context.Context, req *MutexRequest, signal *AcquireLeaseRequest, options ...*client.StartWorkflowOptions) (MutexRun, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *workflowClient) SampleWorkflowWithMutex(ctx context.Context, req *SampleWorkflowWithMutexRequest, options ...*client.StartWorkflowOptions) (*SampleWorkflowWithMutexResponse, error) {
	run, err := c.ExecuteSampleWorkflowWithMutex(ctx, req, options...)
	if err != nil {
		return nil, err
	}
	return run.Get(ctx)
...
func (c *workflowClient) ExecuteSampleWorkflowWithMutex(ctx context.Context, req *SampleWorkflowWithMutexRequest, options ...*client.StartWorkflowOptions) (SampleWorkflowWithMutexRun, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
