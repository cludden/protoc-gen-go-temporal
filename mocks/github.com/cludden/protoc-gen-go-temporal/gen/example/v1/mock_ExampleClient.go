...
func (_m *MockExampleClient) GetUpdateFooProgress(ctx context.Context, req client.GetWorkflowUpdateHandleOptions) (examplev1.UpdateFooProgressHandle, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, client.GetWorkflowUpdateHandleOptions) (examplev1.UpdateFooProgressHandle, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, client.GetWorkflowUpdateHandleOptions) examplev1.UpdateFooProgressHandle); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, client.GetWorkflowUpdateHandleOptions) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockExampleClient_GetUpdateFooProgress_Call) Run(run func(ctx context.Context, req client.GetWorkflowUpdateHandleOptions)) *MockExampleClient_GetUpdateFooProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(client.GetWorkflowUpdateHandleOptions))
	})
	return _c
}
