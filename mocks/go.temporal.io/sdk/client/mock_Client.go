...
func (_c *MockClient_UpdateWorkflow_Call) RunAndReturn(run func(context.Context, string, string, string, ...interface{}) (client.WorkflowUpdateHandle, error)) *MockClient_UpdateWorkflow_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockClient_UpdateWorkflowWithOptions_Call) Run(run func(ctx context.Context, request *client.UpdateWorkflowWithOptionsRequest)) *MockClient_UpdateWorkflowWithOptions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*client.UpdateWorkflowWithOptionsRequest))
	})
	return _c
}

func (_c *MockClient_UpdateWorkflowWithOptions_Call) Return(_a0 client.WorkflowUpdateHandle, _a1 error) *MockClient_UpdateWorkflowWithOptions_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockClient_UpdateWorkflowWithOptions_Call) RunAndReturn(run func(context.Context, *client.UpdateWorkflowWithOptionsRequest) (client.WorkflowUpdateHandle, error)) *MockClient_UpdateWorkflowWithOptions_Call {
	_c.Call.Return(run)
	return _c
}
