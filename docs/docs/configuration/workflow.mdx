...
Identifies a [query](https://docs.temporal.io/workflows#query) supported by the workflow. Can be specified 0, 1, or more times. See the [query docs](/docs/guides/query) for more details.
...
Specifies the default [Workflow search attributes](https://docs.temporal.io/visibility#search-attribute) as a [Bloblang mapping](https://www.benthos.dev/docs/guides/bloblang/about/). See the [Search Attributes example](/examples/searchattributes/) for more details.
...
Identifies a [signal](https://docs.temporal.io/workflows#signal) supported by the workflow. Can be specified 0, 1, or more times. See the [signal docs](/docs/guides/signal) for more details.
...
Identifies an [update](https://docs.temporal.io/workflows#update) supported by the workflow. Can be specified 0, 1, or more times. See the [update docs](/docs/guides/update) for more details. Note that this requires the [workflow-update-enabled](/docs/guides/plugin) plugin option to be enabled.
...
:::note
This requires the [enable-xns](/docs/guides/plugin) plugin option to be enabled.
:::
