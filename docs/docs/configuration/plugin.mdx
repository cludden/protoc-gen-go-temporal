...
Ignores CamelCase renaming of generated protobuf output for the given acronyms.

<Tabs>
<TabItem value="ignore-acronyms-single" label="Buf">
```yaml title="buf.gen.yaml"
plugins:
  - plugin: go_temporal
    out: gen
    opt: ignore-acronyms=AWS
    strategy: all
```
</TabItem>
<TabItem value="ignore-acronyms-multiple" label="Buf">
```yaml title="buf.gen.yaml"
plugins:
  - plugin: go_temporal
    out: gen
...
<TabItem value="ignore-acronyms-single-protoc" label="Protoc">
```sh
protoc --go_temporal_opt=ignore-acronyms=AWS
```
</TabItem>
<TabItem value="ignore-acronyms-single-protoc" label="Protoc">
```sh
protoc --go_temporal_opt=ignore-acronyms=AWS,ignore-acronyms=SQL
```
</TabItem>
</Tabs>
