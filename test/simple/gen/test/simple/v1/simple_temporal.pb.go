...
// versions:
//
//	protoc-gen-go_temporal 0.7.6-next (b7d9a2588c29c702975f7c990b299efe67881088)
//	go go1.20.4
//	protoc (unknown)
//
...
// Simple update names
const (
	SomeUpdate1UpdateName = "mycompany.simple.Simple.SomeUpdate1Update"
)
...
type Client interface {
	...
	// StartSomeWorkflow1 starts a(n) SomeWorkflow1 workflow
	ExecuteSomeWorkflow1(ctx context.Context, req *SomeWorkflow1Request, opts ...*client.StartWorkflowOptions) (SomeWorkflow1Run, error)
	// GetSomeWorkflow1 retrieves a(n) SomeWorkflow1 workflow execution
	...
	// StartSomeWorkflow2 starts a(n) SomeWorkflow2 workflow
	ExecuteSomeWorkflow2(ctx context.Context, opts ...*client.StartWorkflowOptions) (SomeWorkflow2Run, error)
	// GetSomeWorkflow2 retrieves a(n) SomeWorkflow2 workflow execution
	GetSomeWorkflow2(ctx context.Context, workflowID string, runID string) (SomeWorkflow2Run, error)
	// StartSomeWorkflow2WithSomeSignal1 sends a(n) SomeSignal1 signal to a SomeWorkflow2 workflow, starting it if not present
	...
	// StartSomeWorkflow3 starts a(n) SomeWorkflow3 workflow
	ExecuteSomeWorkflow3(ctx context.Context, req *SomeWorkflow3Request, opts ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error)
	// GetSomeWorkflow3 retrieves a(n) SomeWorkflow3 workflow execution
	GetSomeWorkflow3(ctx context.Context, workflowID string, runID string) (SomeWorkflow3Run, error)
	// StartSomeWorkflow3WithSomeSignal2 sends a(n) SomeSignal2 signal to a SomeWorkflow3 workflow, starting it if not present
	StartSomeWorkflow3WithSomeSignal2(ctx context.Context, req *SomeWorkflow3Request, signal *SomeSignal2Request, opts ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error)
	...
	// UpdateSomeUpdate1 sends a(n) SomeUpdate1 update to an existing workflow
	UpdateSomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (SomeUpdate1Handle, error)
}
...
func (c *workflowClient) SomeWorkflow1(ctx context.Context, req *SomeWorkflow1Request, options ...*client.StartWorkflowOptions) (*SomeWorkflow1Response, error) {
	run, err := c.ExecuteSomeWorkflow1(ctx, req, options...)
	if err != nil {
		return nil, err
	}
	return run.Get(ctx)
...
func (c *workflowClient) ExecuteSomeWorkflow1(ctx context.Context, req *SomeWorkflow1Request, options ...*client.StartWorkflowOptions) (SomeWorkflow1Run, error) {
...
func (c *workflowClient) SomeWorkflow2(ctx context.Context, options ...*client.StartWorkflowOptions) error {
	run, err := c.ExecuteSomeWorkflow2(ctx, options...)
	if err != nil {
		return err
	}
	return run.Get(ctx)
...
func (c *workflowClient) ExecuteSomeWorkflow2(ctx context.Context, options ...*client.StartWorkflowOptions) (SomeWorkflow2Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *workflowClient) StartSomeWorkflow2WithSomeSignal1(ctx context.Context, options ...*client.StartWorkflowOptions) (SomeWorkflow2Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *workflowClient) SomeWorkflow3(ctx context.Context, req *SomeWorkflow3Request, options ...*client.StartWorkflowOptions) error {
	run, err := c.ExecuteSomeWorkflow3(ctx, req, options...)
	if err != nil {
		return err
	}
	return run.Get(ctx)
...
func (c *workflowClient) ExecuteSomeWorkflow3(ctx context.Context, req *SomeWorkflow3Request, options ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
func (c *workflowClient) StartSomeWorkflow3WithSomeSignal2(ctx context.Context, req *SomeWorkflow3Request, signal *SomeSignal2Request, options ...*client.StartWorkflowOptions) (SomeWorkflow3Run, error) {
	opts := &client.StartWorkflowOptions{}
	if len(options) > 0 {
		opts = options[0]
	}
...
// UpdateSomeUpdate1 sends a(n) SomeUpdate1 update to an existing workflow
func (c *workflowClient) UpdateSomeUpdate1(ctx context.Context, workflowID string, runID string, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (SomeUpdate1Handle, error) {
...
type SomeWorkflow2Run interface {
	...
	SomeUpdate1(ctx context.Context, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (SomeUpdate1Handle, error)
}
...
// SomeUpdate1 sends a(n) SomeUpdate1 update to the workflow
func (r *someWorkflow2Run) SomeUpdate1(ctx context.Context, req *SomeUpdate1Request, opts ...*client.UpdateWorkflowWithOptionsRequest) (SomeUpdate1Handle, error) {
	return r.client.UpdateSomeUpdate1(ctx, r.ID(), r.RunID(), req, opts...)
}
...
func SomeWorkflow1Child(ctx workflow.Context, req *SomeWorkflow1Request, options ...*workflow.ChildWorkflowOptions) *SomeWorkflow1ChildRun {
...
func SomeWorkflow2Child(ctx workflow.Context, options ...*workflow.ChildWorkflowOptions) *SomeWorkflow2ChildRun {
	var opts *workflow.ChildWorkflowOptions
	if len(options) > 0 {
		opts = options[0]
	} else {
...
func SomeWorkflow3Child(ctx workflow.Context, req *SomeWorkflow3Request, options ...*workflow.ChildWorkflowOptions) *SomeWorkflow3ChildRun {
	var opts *workflow.ChildWorkflowOptions
	if len(options) > 0 {
		opts = options[0]
	} else {
